...
- The **Connection Panels** button in the upper-right corner opens a connection panel view that provides a visual overview of all the connections established between assets with a "connection panel" device type and other assets (see [Configuring device types](xref:AM_Configuring_device_types)):
