...
- ![Rack Visualization](~/solutions/images/Asset_Manager_Rack_Visualization.png) [**Rack Visualization**](xref:Rack_View): Visualizes a rack and allows you to assign and remove assets and reserve slots.
- ![Row View](~/solutions/images/Asset_Manager_Row_View.png) [**Row View**](xref:Row_Viewer): Visualizes the racks in a specific row.
