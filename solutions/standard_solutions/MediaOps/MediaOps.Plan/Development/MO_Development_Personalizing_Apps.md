...
description: Explore the different ways in which you can personalize the MediaOps applications - create custom apps, edit existing apps, or create duplicate apps.
---
