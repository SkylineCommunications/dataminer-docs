...
You can apply a template when you create a new SLA, so you do not have to configure these settings manually every time. For more information, see [Creating an SLA](xref:Managing_SLAs#creating-an-sla).
