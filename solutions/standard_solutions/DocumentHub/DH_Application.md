...
- ![Search Filter Help icon](~/solutions/images/DocumentHub_SharePoint_KQL.png) **Search Filter Help**: Helper screen with guidance for searching files across buckets, including SharePoint Keyword Query Language (KQL).
