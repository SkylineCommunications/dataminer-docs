...
- **[Introduction](xref:SI_Introduction)**: Introduces the app and its main concepts (satellites, beams, transponders, and slots).

- **[Managing satellites](xref:SI_Managing_Satellites)**: How to add and manage the satellites in your inventory.
