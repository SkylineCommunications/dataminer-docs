...
After installation, the SatOps applications ([Satellite Inventory](xref:Satellite_Inventory) and [Satellite Scheduling](xref:Satellite_Scheduling)) are available in your DataMiner System and ready for use out of the box. You can import demo data to quickly set up an environment for evaluation and testing.
