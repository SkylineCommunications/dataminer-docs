...
After installation, the SatOps applications ([Satellite Inventory](xref:Satellite_Inventory) and [Satellite Scheduling](xref:Satellite_Scheduling)) are available in your DataMiner System and ready for use out of the box. To evaluate or test SatOps without configuring an inventory from scratch, deploy the [SatOps demo data](https://catalog.dataminer.services/details/668a9580-1c5d-4215-a20e-b62fdaea5fe8) package, a separate DataMiner Catalog item that populates the apps with sample satellites, beams, and transponders.
