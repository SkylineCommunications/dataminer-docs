...
- If the DataMiner System only contains one element using this protocol, use the procedure for [systems with one backend element](xref:I-DOCSIS_maps_deployment_one_backend).

- If the DataMiner System contains multiple elements using this protocol, use the procedure for [systems with multiple backend elements](xref:I-DOCSIS_maps_deployment_multiple_backends).
