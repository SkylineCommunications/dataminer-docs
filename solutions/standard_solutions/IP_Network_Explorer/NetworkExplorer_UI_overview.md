...
A topology selector is available in the upper-right corner of the Topology view. This allows you to select one of the available topologies to display.
...
You can also use the *ADD* button in the upper-right corner of the application to **create a new topology**. When you do so, you will need to provide the following information:
