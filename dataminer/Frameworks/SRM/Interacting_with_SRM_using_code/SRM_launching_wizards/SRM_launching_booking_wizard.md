...
You can configure a custom frontend script to launch the standard Booking Wizard, and even provide default values for specific fields (service definition, timing, resources, etc.).<!-- RN 29937 -->
