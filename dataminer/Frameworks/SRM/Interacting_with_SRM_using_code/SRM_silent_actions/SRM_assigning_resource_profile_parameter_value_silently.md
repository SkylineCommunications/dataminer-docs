...
> - From SRM 1.2.33 onwards<!-- RN 37080 -->, *AssignResourceRequest* supports capacity reference. For this, the reference string should be passed in the *InputReference* property of the request.
