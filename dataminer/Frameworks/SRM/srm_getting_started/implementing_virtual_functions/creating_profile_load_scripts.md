...
![PLS Tester](~/dataminer/images/PLS_Tester.png)
...
1. At the top of the PLS Tester visual overview, in the *Function* box, select the virtual function for which you want to run a test.
   ...
   ![PLS Tester function selection](~/dataminer/images/PLS_Tester_Function_Selection.png)

1. In the *Resource* box, select a specific virtual function resource.

   ![PLS Tester resource selection](~/dataminer/images/PLS_Tester_Resource_Selection.png)
...
1. Click the *Apply* button.
   ...
   ![PLS Tester pop-up window](~/dataminer/images/PLS_Tester_Apply.png)
