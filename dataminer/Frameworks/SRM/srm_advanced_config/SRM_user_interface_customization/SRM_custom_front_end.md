...
# Creating a custom frontend for the Booking Manager
...
While we do not recommend this, you can create your own customized Visual Overview as an alternative frontend and assign it to the Booking Manager element. See [Setting the active Visio file for an element, service, or view](xref:Set_as_active_Visio_file).
