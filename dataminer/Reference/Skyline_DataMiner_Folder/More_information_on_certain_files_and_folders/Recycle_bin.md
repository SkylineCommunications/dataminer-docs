...
1. [Force a synchronization](xref:Synchronizing_data_between_DataMiner_Agents#forcing-synchronization-of-a-file-with-the-cluster) of the file in the cluster.
