...
<!--| ChatOps | DataMiner ChatOps is being retired and replaced by the [DataMiner Assistant](xref:Assistant_M365). | End of life as of xxx, when ChatOps will no longer be available for installation from the Microsoft Marketplace. |-->
