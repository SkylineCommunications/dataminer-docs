...
> [!NOTE]
>
> This manager is removed from DataMiner starting from version 10.6.0 onwards, as the NATS management is fully migrated to [BrokerGateway](xref:BrokerGateway_Migration). <!-- RN 44035 -->
