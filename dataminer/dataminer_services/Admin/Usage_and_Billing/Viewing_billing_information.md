...
Use the date selector at the top of the page to view billing information for different months, allowing you to analyze costs across different time periods.
...
> [!NOTE]
> The Billing page is only accessible to Owners and Admins of the organization.
