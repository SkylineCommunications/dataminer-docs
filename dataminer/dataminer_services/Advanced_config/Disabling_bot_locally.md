...
From version 2.10.6 of the [FieldControl](xref:DataMinerExtensionModules#fieldcontrol) DxM onwards<!-- RN 39113 -->, it is possible to disable [DataMiner ChatOps](xref:DataMiner_Teams_bot) for a particular server through the app settings of the DxM:
