...
description: "Disable reports and notifications offloading in the configuration file of each DataMiner SupportAssistant DxM."
...
From version 1.3.1 of the [DataMiner SupportAssistant](xref:DataMinerCoreModules#supportassistant) DataMiner Extension Module (DxM) onwards, this DxM also takes care of offloading reports and notifications generated by SLWatchDog to dataminer.services to improve the maintenance and support experience.
