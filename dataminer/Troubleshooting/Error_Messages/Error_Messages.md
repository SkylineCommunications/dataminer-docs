...
- [Initializing the IP failed for x. y (hr = z), please check the IP-settings](xref:Initializing_the_IP_failed_for_x)

- [Initializing the protocol for x failed. y (hr = z)](xref:Initializing_the_protocol_for_x_failed)

- [Initialize xml for x failed. y (hr = z)](xref:Initialize_xml_for_x_failed)

- [Load protocol x failed with y. (hr = z)](xref:Load_protocol_x_failed_with_y)

- [Non authorized client applications are running](xref:Non_authorized_client_applications_are_running)

- [Parsing the settings for x failed. y (hr = z)](xref:Parsing_the_settings_for_x_failed)
...
- [Starting the DERIVED element x failed. y (hr = z)](xref:Starting_the_derived_element_x_failed)

- [Starting the element x failed with y. (hr = z)](xref:Starting_the_element_x_failed_with_y)

- [Starting the protocol for x failed. y (hr = z)](xref:Starting_the_protocol_for_x_failed)
