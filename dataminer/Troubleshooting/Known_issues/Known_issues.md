...
| -- | -- | -- | -- |
| [Values of Cube alarm storm prevention user settings would not be visualized correctly in the UI](xref:KI_Cube_Alarm_storm_prevention) | DataMiner Cube 10.5.0 [CU13]/10.6.0 [CU1]/10.6.4 | | 15 April, 2026 |
...
| [Local user not pushed to Windows](xref:KI_Local_user_not_pushed_to_windows) | From DataMiner 10.4.0 [CU4]/10.4.7 onwards | DataMiner 10.4.0 [CU19]/10.5.0 [CU7]/10.5.10 | March 27, 2025 |
...
| [Unable to open trended parameter cards via Cube advanced search](xref:KI_Unable_to_open_trended_parameter_cards_via_Cube_advanced_search) | DataMiner Cube 10.4.0 [CU12]/10.5.0/10.5.3 and<br> DataMiner Cube 10.4.0 [CU13]/10.5.0 [CU1]/10.5.4 | DataMiner 10.4.0 [CU14]/10.5.0 [CU2]/10.5.5 | March 20, 2025 |
...
| [Incorrect date sorting in Bookings app with custom column configurations](xref:KI_Incorrect_date_sorting_in_Bookings_app_with_custom_column_configurations) | SRM setups with custom column configurations created prior to DataMiner 10.2.0 [CU10]/10.3.1 | Requires manual intervention | January 5, 2026 |
