...
When a report times out, this is most likely related to reports generating a lot of data, and the default timeout configuration might not be sufficient. To fix this, you can adjust the timeout. For more information, refer to [MaintenanceSettings.SLASPConnection.ReportResponseTimeout](xref:MaintenanceSettings.SLASPConnection.ReportResponseTimeout).
