...
From DataMiner web 10.4.0 [CU20]/10.5.0 [CU8]/10.5.11 onwards, PDFs are generated by the [Web](xref:DataMinerExtensionModules#web) DcM. If it fails to generate a PDF, check the logging in `C:\ProgramData\Skyline Communications\DataMiner Web\Logs`.<!-- RN 43439 -->
