...
Logging for the [Web DcM](xref:DataMinerCoreModules#web) is available in `C:\ProgramData\Skyline Communications\DataMiner Web\Logs`.
...
From DataMiner web 10.5.0 [CU8]/10.5.11 onwards, PDFs are generated by the [Web DcM](xref:DataMinerCoreModules#web). If it fails to generate a PDF, check the logging in `C:\ProgramData\Skyline Communications\DataMiner Web\Logs`.<!-- RN 43439 -->
...
From DataMiner web 10.5.0 [CU8]/10.5.11 onwards, WAF rule books are generated by the [Web DcM](xref:DataMinerCoreModules#web). In earlier DataMiner versions, they are generated by [SLHelper](xref:Troubleshooting_SLHelper_exe).
