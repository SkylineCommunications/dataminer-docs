...
- Logging is available at `C:\ProgramData\Skyline Communications\DataMiner Web\Logs`.
...
Since web version 10.5.11, PDFs are generated by the Web DcM. If it fails to generate a PDF, check the logging at `C:\ProgramData\Skyline Communications\DataMiner Web\Logs`.

Prior to 10.5.11, PDFs are generated by [SLHelper](xref:Troubleshooting_SLHelper_exe). If it fails to generate a PDF, check the following log files:
...
Since web version 10.5.11, WAF rulebooks are generated by the Web DcM. Prior to web version 10.5.11, WAF rulebooks are generated by [SLHelper](xref:Troubleshooting_SLHelper_exe).
...
- Since web version 10.5.11, are there any errors in the logging of the Web DcM (`C:\ProgramData\Skyline Communications\DataMiner Web\Logs`)?
- Prior to web version 10.5.11, in the *SLNet Client Test* tool, follow the newly created HTML5 connection. Does it return any errors?
