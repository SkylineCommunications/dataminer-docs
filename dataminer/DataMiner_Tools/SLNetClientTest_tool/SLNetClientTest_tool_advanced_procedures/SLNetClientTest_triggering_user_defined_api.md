...
1. Select the *Trigger* tab.
   ...
   ![Client Test Tool Trigger Screenshot](~/dataminer/images/UDAPIS_ClientTestToolTrigger.png)
...
![Client Test Tool Screenshot](~/dataminer/images/UDAPIS_ClientTestTool.png)
