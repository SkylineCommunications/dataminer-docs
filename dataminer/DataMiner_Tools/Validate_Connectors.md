---
uid: Validate_Connectors
---

# Validate Connectors

This prerequisite check scans the DataMiner System for any connectors that are known to be incompatible with the DataMiner version to which the DataMiner Agent is being upgraded. If such connectors are found, they will have to be removed before you can continue with the upgrade.

The prerequisite check runs automatically when you upgrade to 10.3.4/10.4.0 or higher. <!-- RN 35605 -->
