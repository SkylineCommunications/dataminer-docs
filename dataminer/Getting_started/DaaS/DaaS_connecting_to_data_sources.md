...
![Connecting to different data sources with DaaS](~/dataminer/images/DataSources.svg)
...
To connect to resources in your private network, DaaS can connect using an DataMiner Edge or a VPN gateway. For more details, see [Connecting to private data sources with DaaS](xref:Connecting_to_private_data_sources).
