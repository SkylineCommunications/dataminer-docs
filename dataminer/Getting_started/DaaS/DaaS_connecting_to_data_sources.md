...
To connect to resources in your private network, DaaS can connect using DataMiner Edge or a VPN gateway. For more details, see [Connecting to private data sources with DaaS](xref:Connecting_to_private_data_sources).
