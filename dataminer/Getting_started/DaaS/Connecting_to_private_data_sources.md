...
From **DataMiner 10.5.10/10.6.0** onwards, Edge Manager is available on DaaS systems by default. It requires the installation of a zrok agent on premises to establish the secure communication tunnels.
