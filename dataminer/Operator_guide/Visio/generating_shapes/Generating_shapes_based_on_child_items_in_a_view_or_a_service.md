...
- **ChildrenFilter**:
  ...
  - From DataMiner 10.2.0/10.1.2 onwards, you can filter service, view and element children by name, by specifying a regular expression in the following format in the shape data: *Name=Regex*.
    ...
    > [!NOTE]
    > If the regular expression contains pipe characters ("\|"), the separator should be changed. More informaition in [About using separator characters]((xref:Linking_a_shape_to_a_SET_commands#About-using-separator-characters)).
