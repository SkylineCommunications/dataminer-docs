...
![Discrete parameter toggle button](~/dataminer/images/Discrete_Parameter_Toggle.png)<br>*Discrete parameter with toggle control in DataMiner 10.6.5*
...
![Discrete parameter selection box](~/dataminer/images/Discrete_Parameter_Selection_Box_Control.png)<br>*Discrete parameter with selection box control in DataMiner 10.6.5*
...
![Discrete parameter text box](~/dataminer/images/Discrete_Parameter_Text_Box.png)<br>*Discrete parameter with text box control in DataMiner 10.6.5*
