...
![Pattern matching](~/dataminer/images/Pattern_Matching.png)<br>*Trending: detected pattern in DataMiner 10.4.5*
...
The ![multivariate](~/dataminer/images/multivariate_icon.png) icon indicates that the pattern combines trend information from different parameters. By clicking this icon, you can load all trend graphs of the parameters that are part of the pattern. <!-- RN 36628 -->
