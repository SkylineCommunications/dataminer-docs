...
In older DataMiner versions (prior to DataMiner 10.6.0), this page allows you to add, view, and edit extensive annotations for the view. With the pencil icon on this page, you can open an HTML editor that allows you to add text, hyperlinks, pictures, etc. to the annotations. There is also an icon that can be used to print the annotations, and an icon to refresh the annotations page.
