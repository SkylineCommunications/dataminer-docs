...
To qualify for non-production billing, an Organization must meet all of the following:
...
> **Important:** Skyline reserves the right to review non-production Organization usage. Systems found running production workloads under a non-production Organization will be reclassified and billed at standard rates.
