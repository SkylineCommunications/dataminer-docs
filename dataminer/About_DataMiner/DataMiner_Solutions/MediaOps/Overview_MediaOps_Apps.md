...
![People and Organizations app icon](~/dataminer/images/DM_PeopleOrganizations.png)
...
![Resource Studio app icon](~/dataminer/images/DM_ResourceStudio.png)
...
![Workflow Designer app icon](~/dataminer/images/DM_WorkflowDesigner.png)
...
![Scheduling app icon](~/dataminer/images/MediaOps_ICON_7.png)
...
![Virtual Signal Groups app icon](~/dataminer/images/DM_VirtualSignalGroup.png)
...
![Control Surface app icon](~/dataminer/images/DM_ControlSurface.png)
...
![Flow Engineering icon](~/dataminer/images/DM_FlowEngineering.png)
...
![Flow Monitoring app icon](~/dataminer/images/DM_FlowMonitoring.png)
...
![Cost and Billing app icon](~/dataminer/images/cost-billing-dm-logo.png)
