...
description: Learn about DataMiner Solutions, which convert data and controls into value by leveraging the platform's enabling functions and features.
---
...
A DataMiner Solution, in general, can refer to any type of setup or configuration of a DataMiner platform, leveraging one or more of its enabling functions (e.g., Visual Overview graphics, automation scripts, connectors, no-code Apps, User-Defined APIs, ad hoc data sources, and much more). These solutions are stored in the Catalog and can be loaded on any DataMiner System that meets the minimum requirements.
