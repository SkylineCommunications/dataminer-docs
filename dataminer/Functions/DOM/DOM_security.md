...
1. Link to a `DomDefinition` and `FieldDescriptor`. This type of link determines which groups can access a subset of the `DomInstance` objects of a definition based on the value(s) of a specific field.
