...
1. Under *Actions*, click *Add* and select which action should be executed:
   ...
   > - For the *Email* action, specify at least one recipient in the *To*, *CC*, and/or *BCC* fields. Prior to DataMiner 10.4.0 [CU21]/10.5.0 [CU9]/10.5.12<!--RN 43848-->, specify at least one *To* recipient, and make sure all recipients are present in your contact list.
