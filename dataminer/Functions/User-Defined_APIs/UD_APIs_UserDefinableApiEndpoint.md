...
- **RateLimitNotificationIntervalSeconds**: Optional. The cooldown time before the endpoint will notify DataMiner when a rate limit is exceeded. Set to 60 seconds by default.
