...
- The [.NET 10](https://dotnet.microsoft.com/en-us/download/dotnet/10.0) hosting bundle must be installed on the server where you want to install Data Aggregator.
