...
> - While data is being loaded in a dashboard, an activity indicator is displayed in the upper-right corner of the page. You can click the indicator to see the number of calls in progress.
