...
When the *Router Control* module opens, the default configuration (i.e., user interface) is automatically selected. If, for any reason, you are currently in a custom Router Control configuration, click the *Default* button in the upper-right corner to go to the default configuration.
