...
> [!IMPORTANT]
> Linking this operator to parameters is obsolete. It is no longer available from DataMiner 10.4.0 onwards.

From DataMiner 10.2.0/10.1.5 onwards, you can add parameters from existing data in the dashboard to the selectable items. Prior to DataMiner 10.3.5<!--  RN 35837 -->, you can do so using the *Use feed* checkbox. In more recent DataMiner versions, you can instead click the link icon to the right of the relevant selection box.
