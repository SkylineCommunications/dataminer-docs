...
Available in soft launch from DataMiner 10.3.9/10.4.0 onwards<!--RN 36231-->, the *Get resource usages* data source retrieves resource usage records in the DataMiner System. Each record includes the resource ID, booking ID, booking start, and booking end.

When configuring this data source, you must first specify for which DataMiner object resource usage records should be retrieved:
