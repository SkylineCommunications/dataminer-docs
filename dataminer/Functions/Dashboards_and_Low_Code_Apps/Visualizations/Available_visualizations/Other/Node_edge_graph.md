...
At any time during an interaction, you can press ESC to cancel the action and restore the item ot its original state (available from DataMiner 10.5.0 [CU14]/10.6.0 [CU2]/10.6.5 onwards<!--RN 44938-->).
