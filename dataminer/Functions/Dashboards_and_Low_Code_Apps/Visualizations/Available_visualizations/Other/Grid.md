...
When you select an item in the grid, the selected data (e.g., *All available data* > *Components* > *[Page/Panel name]* > *Grid* > *Selected items* > *Tables*) becomes automatically available for use in other components.
...
This can for instance be useful when the grid's [component data](xref:Component_Data) (e.g., *Components* > *[Page/Panel name]* > *Grid* > *Selected items* > *Tables*) is used in another component. The highlight helps users identify which data is driving the content of the linked component.
...
1. From DataMiner 10.5.0 [CU12]/10.6.3 onwards<!--RN 44015-->, navigate to *All available data* > *Components* > *[Page/Panel name]* > *Query filter* in the *Data* pane, and drag the *Query columns* data item onto your grid component.
