...
- On the left side is a filter section, which you can use to navigate to specific objects in the topology.

- On the right side, a large pane provides an overview of whatever object is selected in the currently selected chain.
