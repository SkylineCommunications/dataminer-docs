...
- *Suggestion limit*: Available from DataMiner 10.5.0 [CU13]/10.6.0 [CU1]/10.6.4 onwards<!--RN 44709-->. Determines the maximum number of active suggestion events per behavioral change type (default: 50).
