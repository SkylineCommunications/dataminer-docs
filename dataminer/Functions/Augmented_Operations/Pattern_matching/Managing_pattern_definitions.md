...
> [!NOTE]
> From DataMiner 10.3.8/10.4.0 onwards, the *Pattern Overview* window also supports [multivariate patterns](xref:Pattern_matching#multivariate-patterns)<!-- RN 35010 -->.
