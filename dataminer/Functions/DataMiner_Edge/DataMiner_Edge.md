...
- [Edge Gateway mode](xref:About_Edge_Gateways) uses a secure gateway or tunnel to access remote data sources while connector logic and workflows continue to run centrally in DataMiner.

Edge Nodes are supported from DataMiner 10.5.0 [CU19]/10.6.0 [CU7]/10.6.10 onwards<!--RN 46037, 46072, and 46142-->. Edge Gateways are available from DataMiner 10.5.10/10.6.0 onwards.
