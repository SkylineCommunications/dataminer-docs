...
1. From DataMiner 10.6.10/10.7.0 onwards<!--RN 46061-->, if the selected backup contains a passphrase-wrapped encryption envelope (i.e., it was taken on a system with a [DMS backup password](xref:Encryption_in_DataMiner#credentials-at-rest) configured), and you are restoring on a different machine, enter the password in the *DMS Backup Password* field and click *Verify*.
