...
description: "Follow these steps to manually connect a DMA to an existing OpenSearch or legacy Elasticsearch indexing cluster in a self-managed storage setup."
---
