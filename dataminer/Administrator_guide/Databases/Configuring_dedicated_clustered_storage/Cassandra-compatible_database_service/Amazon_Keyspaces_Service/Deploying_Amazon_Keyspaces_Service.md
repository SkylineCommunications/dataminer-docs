...
1. Keep selecting *Next* or *Finish* until the certificate is successfully imported.
   ...
   ![Add Certificate](~/dataminer/images/aks_add_certificate.png)
...
1. Go to *IAM* > *Users*.
   ...
   ![IAM](~/dataminer/images/Amazon_Keyspaces_IAM.png)
...
1. Verify that this account has full access to Amazon Keyspaces, i.e., the permission *AmazonKeyspacesFullAccess*.
   ...
   1. Select *Add permissions*.
      ...
      ![AddPermissions](~/dataminer/images/Amazon_Keyspaces_AddPermissions.png)
   ...
   1. Select the permission and click *Next*.
      ...
      ![AddKeyspacesPermission](~/dataminer/images/Amazon_Keyspaces_AddKeyspacesPermission.png)

1. To generate the credentials, go to the *Security credentials* tab.

   ![SecurityCredentials](~/dataminer/images/Amazon_Keyspaces_Security_Tab.png)

1. Scroll down to the Amazon Keyspaces part.

   ![AmazonKeyspacesSecurityCredentials](~/dataminer/images/Amazon_Keyspaces_Credentials.png)
