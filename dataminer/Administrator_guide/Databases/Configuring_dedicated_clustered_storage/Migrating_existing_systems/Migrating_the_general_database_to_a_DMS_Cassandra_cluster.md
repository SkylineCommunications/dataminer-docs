...
> - From DataMiner 10.6.10/10.7.0 onwards<!--RN 45824-->, the Cassandra Cluster Migrator tool also supports migrating credential types that inherit from `ACredentialConfig`, i.e., all credential types that can be created in the Credentials Library.
