...
> [!NOTE]
> The updates required to support [offload databases with Swarming enabled](xref:Offload_Database_With_Swarming) are not automatically applied. These updates require manual queries to be executed before enabling Swarming.
