...
> [!NOTE]
> The `EId` column in the alarm table is not required to be part of the primary key in environments that do not have Swarming enabled. However, having this column part of the primary key is always recommended.
...
> [!NOTE]
> This table is not currently supported on Swarming-enabled environments. See [Offload database configuration with Swarming enabled](xref:Offload_Database_With_Swarming) for more information.
...
> [!NOTE]
> The `EId` column in the info table is not required to be part of the primary key in environments that do not have Swarming enabled. However, having this column part of the primary key is always recommended.
