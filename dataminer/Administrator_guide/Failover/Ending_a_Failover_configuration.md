...
> [!TIP]
> If you also want to remove the online Agent from the DataMiner System, refer to [Removing a Failover DMA](xref:Removing_a_DataMiner_Agent_from_a_DataMiner_System#removing-a-failover-agent).
