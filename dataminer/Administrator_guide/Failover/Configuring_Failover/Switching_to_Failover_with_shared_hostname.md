...
Alternatively, you can shut down both DataMiner Agents and adjust the Failover configuration directly in [DMS.xml](xref:DMS_xml). However, we advise against this approach unless shutting down both DMAs simultaneously is not a problem for you and you are familiar with the *DMS.xml* configuration.
