...
The SiteManager module is used by Gateway mode to set up secure communication tunnels enabling access to on-premises data sources from a DaaS system. It is supported from DataMiner 10.5.10/10.5.0 onwards and is included in the 10.5.10 DaaS image.

For more information, refer to [Gateway mode](xref:GatewayModeOverview).
