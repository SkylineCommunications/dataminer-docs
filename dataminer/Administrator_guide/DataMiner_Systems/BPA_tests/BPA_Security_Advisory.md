...
- Operating system
  ...
  - Local admin hygiene: Verifies if the local admin account is disabled and if there are not too many local administrator accounts. Starting from DataMiner 10.6.3/10.6 [CU0]/10.5 [CU12], this test is no longer present and the [recommendation in the hardening guide](xref:DataMiner_hardening_guide#securely-manage-the-local-administrator-account) had been updated <!-- RN 44444 -->.
