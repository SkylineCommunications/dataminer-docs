...
description: "Learn about the Active Runtime Errors BPA test, which detects the presence of active runtime errors in the system by reading the SLWatchdog2.txt file."
---

# Active Runtime Errors

Prior to DataMiner 10.4.12/10.5.0 [CU10]<!--RN 40751-->, this BPA test is called "Report Active RTE".
