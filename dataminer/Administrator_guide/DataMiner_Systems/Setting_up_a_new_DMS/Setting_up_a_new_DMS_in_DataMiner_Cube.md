...
1. [Add the additional DataMiner Agents](xref:Adding_a_DataMiner_Agent_to_a_DataMiner_System).

All DataMiner Agents that have been added to the DMS will start the initial data synchronization. Each DMA will sync with the first other DMA it comes across in *DMS.xml*.
