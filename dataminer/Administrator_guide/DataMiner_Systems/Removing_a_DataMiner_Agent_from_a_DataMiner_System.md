...
> [!NOTE]
> If a [manual configuration was forced for NATS](xref:Disabling_automatic_NATS_config), you will need to manually adjust your NATS configuration with the removed DMA.
