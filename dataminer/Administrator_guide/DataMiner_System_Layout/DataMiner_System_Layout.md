...
DMPs can support a multitude of applications and are typically installed in e.g., remote VSAT terminals, satellite hubs, terrestrial transmitter sites, small network nodes, cellular network base stations, etc.
