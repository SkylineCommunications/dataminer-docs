...
| xCoord | Integer | The X coordinate of the upper-left corner of the region (number of pixels measured from the left). |
| yCoord | Integer | The Y coordinate of the upper-left corner of the region (number of pixels measured from the left). |
