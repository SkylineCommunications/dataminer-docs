...
| Item | Format | Description |
|--|--|--|
| GetAlarmStateTimelineForServiceResult | [DMATimeline](xref:DMATimeline) | An array of alarm state changes along with the start time and end time of the time span in which they occur. |
