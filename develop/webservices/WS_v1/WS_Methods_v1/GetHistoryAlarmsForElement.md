...
| utcStartTime | Long integer | The start time of the time span for which alarms should be retrieved, in UTC format (milliseconds since midnight January 1, 1970 GMT). |
| utcEndTime | Long integer | The end time of the time span for which alarms should be retrieved, in UTC format (milliseconds since midnight January 1, 1970 GMT). |
...
| Item | Format | Description |
|--|--|--|
| GetHistoryAlarmsForElementResult | Array of [DMAAlarm](xref:DMAAlarm) | The alarms for the specified element and period, limited by the specified filters. |
