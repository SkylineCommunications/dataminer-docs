...
> [!NOTE]
>
> - This kind of toggle button can only be used to set a parameter, not to, for example, execute an automation script. In other words, always add a shape data field of type **Execute** on group level of which you set the value to "Set\|..."
