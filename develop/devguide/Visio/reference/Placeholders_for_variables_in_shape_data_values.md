...
- Many of the advanced features described below apply to DataMiner Cube only. For an overview of features not supported in the web apps, see [Unsupported capabilities](xref:DashboardVisualOverview#unsupported-capabilities).
