...
- Via the `Skyline.DataMiner.Core.GQI.Extensions` NuGet package.
  - This is the recommended API when creating GQI extensions from DataMiner 10.6.6/10.5.0 [CU15]/10.6.0 [CU3] onwards. Newer GQI features will only be supported by this API.
  - Requires DIS.
