...
Represents a filter that matches when all of the filters in a set of sub-filters match.
...
| ---- | ---- | ----------- |
| Filters | IReadOnlyList<[IGQIFilter](xref:GQI_IGQIFilter)> | The set of sub-filters. |
