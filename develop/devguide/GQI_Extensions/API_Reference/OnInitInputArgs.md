...
| Session | [IGQISession](xref:GQI_IGQISession) | Object with info about the current query session.<br>Available from DataMiner 10.5.0 [CU12]/10.6.3 onwards.<!-- RN 44509 --> |
