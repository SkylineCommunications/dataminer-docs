...
| Culture | `CultureInfo` | The culture of the user that opened the current query session. | 10.6.7/10.5.0 [CU16]/10.6.0 [CU4] <!-- RN 45348 -->
| TimeZone | `TimeZoneInfo` | The timezone of the user that opened the current query session. | 10.6.7/10.5.0 [CU16]/10.6.0 [CU4] <!-- RN 45348 --> |
