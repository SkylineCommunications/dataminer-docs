...
You can install the package on a single DMA. If more DMAs are present in the cluster, the package will utilize at most three DMAs to create a frontend element, two backend elements, and three collectors, distributing them across the DMAs as follows:

- Agent 1:

  - **EPM Training Frontend**

- Agent 2:

  - **EPM Training Backend 1**
  - **EPM Training Collector 1**
  - **EPM Training Collector 2**

- Agent 3:

  - **EPM Training Backend 2**
...
The frontend element has minimal information in its local tables. It retrieves all the DMS information via view tables.
