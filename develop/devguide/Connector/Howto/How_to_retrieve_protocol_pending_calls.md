...
> - In case element issues are encountered while a [Log Collector package](xref:Collecting_data_to_report_an_issue_to_TechSupport) is generated, SLLogCollector will request the pending calls as well. You can find these in a subfolder within the logging folder.
