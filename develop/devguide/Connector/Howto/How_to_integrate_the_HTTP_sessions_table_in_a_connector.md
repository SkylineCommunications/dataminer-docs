...
description: "Add an HTTP Sessions table to a connector to inspect request-response pairs, reveal data loss, measure durations, and support real-time troubleshooting."
---
