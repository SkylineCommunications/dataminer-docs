...
> [!NOTE]
> If the [DateTime.Kind](https://docs.microsoft.com/en-us/dotnet/api/system.datetime.kind?view=netframework-4.6.2) property of the timeInfo argument is Unspecified, the timestamp will be handled as local time.
