...
> - **Runtime limit:** From DataMiner 10.4.9/10.5.0 onwards<!--RN 39836-->, the maximum number of rows in a volatile table is 1,005,000. The maximum number of rows in a non-partial table is 105,000. Beyond either limit, you will be unable to add new rows; warnings are displayed at 805,000 and 85,000 rows respectively. These are row-count limits, not throughput targets.
