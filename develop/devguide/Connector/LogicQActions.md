...
A QAction results in a DLL which is also stored in this folder(C:\Skyline DataMiner\ProtocolScripts, C:\Skyline DataMiner\Files) . This raises the question whether a QAction can reference another QAction to use functionality defined in the other QAction. This is indeed possible.
