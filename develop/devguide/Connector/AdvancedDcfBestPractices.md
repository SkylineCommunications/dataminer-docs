...
A custom script “Connectivity Discovery” per CI type can be run for an element (refer to <xref:ConnectivityDiscoveryScript>). Like with any custom script, it integrates with the connector and the element (the digital twin of the equipment).
