...
description: "Describe the DataMiner connector development topic Export rules, including its purpose, behavior, implementation guidance, and relevant constraints."
area: develop
