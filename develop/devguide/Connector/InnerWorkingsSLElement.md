...
description: "Describe the DataMiner connector development topic SLElement, including its purpose, behavior, implementation guidance, and relevant constraints."
area: develop
