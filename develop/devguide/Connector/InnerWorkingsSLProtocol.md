...
|Execute next       |Adds the specified group(s) at the beginning of the group execution queue, it will be picked up as soon as the currently being executed group has finished.         |
...
|Execute one top    |Checks if the specified group(s) are present on the queue. If present, nothing will happen. If not present, the group is added at the beginning of the group execution queue, it will be picked up as soon as the currently being executed group has finished.         |
