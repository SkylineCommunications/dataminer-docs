...
- httpRequestInfo[1] (string[]): Request settings.
  ...
  - requestSettings[6]: Specifies whether to skip the SSL/TLS certificate verification. Default: false. Feature introduced in DataMiner 10.4.12 (RN 40877, RN 41285).
