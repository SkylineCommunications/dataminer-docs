...
> - When a TextBox is used as multiline input, the new line characters will differ depending on the environment an interactive automation script is executed in. See [IsMultiline](xref:Skyline.DataMiner.Automation.UIBlockDefinition.IsMultiline) for more details.
