...
> - From DataMiner 10.6.4 onwards<!-- RN 44742 / RN 44788 -->, scripts executed in web apps will also have access to that time zone information via [engine.ClientInfo.TimeZone](xref:Skyline.DataMiner.Automation.IClientInfo.TimeZone), without requiring any user interaction.
