...
- [Skyline.DataMiner.Core.DataMinerSystem.Automation](xref:Skyline.DataMiner.Library.Protocol): This namespace contains all the types that are only relevant in protocols.
