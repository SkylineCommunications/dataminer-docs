...
|[triggerPackagePipelineOnChange](xref:Manifest.Content.Functions.Function.Version.Selection.Range-triggerPackagePipelineOnChange)|[EnumTrueFalse](xref:Manifest-EnumTrueFalse)|Yes|Specifies whether a change on this items should trigger the package pipeline chain.|
