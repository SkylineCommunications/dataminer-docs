...
|[triggerPackagePipelineOnChange](xref:Manifest.Content.CompanionFiles.CompanionFile.Version.Selection.Range-triggerPackagePipelineOnChange)|[EnumTrueFalse](xref:Manifest-EnumTrueFalse)|Yes|Specifies whether a change to this item should trigger the package pipeline chain.|
