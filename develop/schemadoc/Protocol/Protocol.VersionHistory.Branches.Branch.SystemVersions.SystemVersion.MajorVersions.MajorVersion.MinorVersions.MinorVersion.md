...
|&nbsp;&nbsp;[References](xref:Protocol.VersionHistory.Branches.Branch.SystemVersions.SystemVersion.MajorVersions.MajorVersion.MinorVersions.MinorVersion.References)|[0, 1]|Provides references to, for example, registration systems.|
