...
In case you have a suggestion for a unit to be added to the list below, create a Pull Request on the [XML Schemas](Skyline.DataMiner.XmlSchemas) repository. For more information on how to add units, refer to [How to add units](https://github.com/SkylineCommunications/Skyline.DataMiner.XmlSchemas/tree/main/Protocol#how-to-add-units).
