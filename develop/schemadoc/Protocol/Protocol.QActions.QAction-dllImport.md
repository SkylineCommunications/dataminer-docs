...
If the DLL file is stored in C:\Skyline DataMiner\ProtocolScripts\DllImport folder, there is no need to specify the subfolder in the protocol. From DataMiner 9.6.12 (RN 23565) onwards DLL files stored in C:\Skyline DataMiner\ProtocolScripts\DllImport will have precedence over DLL files stored in C:\Skyline DataMiner\ProtocolScripts folder.
...
> - DLL files stored in C:\Skyline DataMiner\ProtocolScripts\DllImport will take precedence over DLL files in other folders, if the above is not true.
