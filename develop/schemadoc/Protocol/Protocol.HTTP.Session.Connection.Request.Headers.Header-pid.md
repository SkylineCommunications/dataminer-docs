...
description: "Learn how the pid attribute identifies the parameter whose value is inserted into an HTTP request header in a DataMiner connector protocol."
---
