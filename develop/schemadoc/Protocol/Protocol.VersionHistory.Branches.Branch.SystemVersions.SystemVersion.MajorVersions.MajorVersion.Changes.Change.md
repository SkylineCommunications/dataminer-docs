...
description: "Consult the DataMiner connector protocol schema reference for the Change element, which documents a major protocol change, its impact, and actions."
---
