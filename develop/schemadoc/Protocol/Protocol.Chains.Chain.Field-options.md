...
Combined with the [detailTabs](#detailtabs) option. Use this option to hide the panel on the right with the KPIs of the selected item. Specify the option immediately after the ID of the list, using a dash as separator.
