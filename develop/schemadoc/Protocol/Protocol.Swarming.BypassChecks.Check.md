...
A smart-serial connection in server mode is by default not allowed to be swarmed. This check can be ignored when the element is able to configure where the data source should send its data to.
