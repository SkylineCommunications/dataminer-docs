...
description: "Learn how to use the Parameters element to define the parameter values to include as key-value pairs in an HTTP request in a DataMiner connector protocol."
---
