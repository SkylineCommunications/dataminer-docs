...
description: "Reference the DataMiner Automation script schema entry for InteractivityOptions simple type, including its documented structure, attributes, values, and c."
---
