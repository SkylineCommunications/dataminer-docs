...
- **Test Runs To Keep:** Determines how many test runs and their results are kept in memory for fast access, with a maximum of 499. Set this to the lowest number you need to validate your quality gates and debug issues. Currently, QAOps does not provide long-term storage. This feature is planned for Q3 2026.
...
For QAOps-hosted configurations, the **DataMiner type** is currently always *DaaS* and the **database type** is *Storage as a Service*.
