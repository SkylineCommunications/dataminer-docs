...
1. Make sure *Place solution and project in the same directory* is not selected.

1. Click *Next*.

1. Enter your name or initials in the *Author* field.
...
1. In the header bar, specify a name for your app, for example, `QAOps tutorial`.

1. Click *Create page*.

1. Hover the mouse pointer over the colored bar with *+* to open the visualizations panel.

1. From the *General* section of the visualizations panel, drag the *Text* visualization onto your page to create a component that will display text.

   ![Text visualization in the visualizations pane](~/develop/images/QAOps_Tutorial_Text_visualization.png)
...
1. Select your new *Text* component, go to *Settings*, and enter an expression similar to `Welcome {COMPONENT."Current view"."Text input 2".Value.Texts.Value}`.
   ...
   ![Settings pane for Text component showing how Intellisense helps you choose the next value](~/develop/images/QAOps_Tutorial_Text_Intellisense.png)
...
1. In the menu bar, select *Extensions* > *DIS* > *DMA* > *Connect*.
...
1. If Visual Studio has added spaces around the colons in the first three lines, make sure to remove those spaces.
...
1. Replace the identifier in the URL with the identifier you saved in [step 2](#step-2-create-a-low-code-app-to-be-tested).
