...
description: Learn how to create a self-hosted QAOps configuration and connect your own DataMiner Agent or cluster with the Configure Self-Hosted DataMiners wizard.
---
...
In this tutorial, you will learn how to create a **self-hosted** [QAOps configuration](xref:QAOps_Configuration) and connect either a single DataMiner Agent or a DataMiner cluster to it, using the *Configure Self-Hosted DataMiners* wizard.
