...
> [!NOTE]
> When DVE elements are defined in the protocol, the dropdown box in the upper-left corner allows you to select either the main protocol or one of the DVE elements. The editor will then only display the pages and parameters of the item you selected.
