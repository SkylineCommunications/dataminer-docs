...
## [Debugging an automation script solution](#tab/automation-1)

1. Open the Visual Studio solution that contains the automation script you want to debug.
...
1. In the Exe blocks list:
    ...
    1. If necessary, in the *Project* column, select another Exe block project.
