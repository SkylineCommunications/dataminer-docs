...
1. Make sure that, in the [DMA](xref:DIS_settings#dma) tab of the *DIS Settings* window, you have added your local DataMiner Agent with the correct user account and you have **not** selected its *Enable remote debugging* option.
