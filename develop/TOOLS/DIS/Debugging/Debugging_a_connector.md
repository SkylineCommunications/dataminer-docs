...
## [Debugging a protocol solution](#tab/protocol-1)

1. Open the protocol Visual Studio solution.
...
1. In the QAction list:
    ...
    1. If necessary, in the *Project* column, select another QAction project.
...
## [Debugging protocol XML file](#tab/protocol-2)
