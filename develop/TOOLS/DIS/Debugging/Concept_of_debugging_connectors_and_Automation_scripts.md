...
| 8. Eject QAction(s) | In the *DIS Inject* tool window, you detach the injected QAction project(s) (using the red x icon). This will now ensure the regular QAction is executed again instead of the injected one. |
