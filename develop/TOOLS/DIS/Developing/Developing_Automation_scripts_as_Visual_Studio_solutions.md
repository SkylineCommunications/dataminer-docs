...
There are some instruction video's to create Visual Studio Automation Script Solutions on the following link: https://community.dataminer.services/courses/dataminer-automation/
