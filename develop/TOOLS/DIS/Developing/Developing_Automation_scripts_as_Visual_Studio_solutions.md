...
## Saving a compiled script to a dmapp file
...
## Saving all compiled scripts in a solution to a dmapp file

To save a compiled version of all Automation scripts in a solution to a dmapp file (with all C# code in their Exe blocks and required DLL files), do the following:
