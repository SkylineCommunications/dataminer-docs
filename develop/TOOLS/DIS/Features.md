...
After you have installed the DataMiner Integration Studio extension, Microsoft Visual Studio turns into a full-blown DataMiner IDE with the following editors:
...
- A [version editor](xref:Version_editor), which allows you to edit the version history.
