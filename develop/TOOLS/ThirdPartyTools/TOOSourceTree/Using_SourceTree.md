...
After starting up SourceTree, you will see a window where you can select a repository. Press the *Local* button in the upper-left corner to open a local repository. Here you can either specify the path to a local repository or drag and drop a Git repository folder.
...
On the left, you will see an overview of the local and remote branches as well as the different tags. On the right, you will see a tree view showing the different branches, commits and tags.
