...
|[WinDbg](xref:WinDbg)     |WinDbg is a tool for debugging that can be used for analyzing crash dumps, debugging live user-mode and kernel-mode code, and examine CPU registers and memory.        |Debugger         |
