...
| Item | Format | Description |
|--|--|--|
| GetAlarmStateTimeline­ForElementResult | [DMATimeline](xref:DMATimeline) | An array of alarm state changes along with the start time and end time of the timespan in which they occur. |
