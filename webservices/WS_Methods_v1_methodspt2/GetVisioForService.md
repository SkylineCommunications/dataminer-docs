...
The page is returned as an interactive image containing clickable regions linked to a certain action, and scrollable child regions. If you want the page to be returned as a static image, then use GetVisioThumbnailForService instead (see [GetVisioThumbnailForService](xref:GetVisioThumbnailForService) ).
