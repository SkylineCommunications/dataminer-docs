...
The search functionality in the DataMiner documentation is powered by Azure AI Search. By default, the search uses [wildcard matching](https://learn.microsoft.com/en-us/azure/search/query-lucene-syntax#bkmk_wildcard) to help you find relevant results even when search terms are incomplete or slightly different from the indexed content.
