...
From a storage point of view, DataMiner is equipped with Cassandra and Elasticsearch storage solutions. These databases can be run on premises, in a private cloud, hybrid or in a public cloud. Cassandra and Elasticsearch clustering capabilities are supported.
