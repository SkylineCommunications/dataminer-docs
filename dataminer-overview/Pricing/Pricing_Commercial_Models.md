...
- **DataMiner as a Service**: Express systems [deployed as a service](xref:Creating_a_DMS_in_the_cloud) are free for the first 15 days, and require a subscription or pay-per-use credits after that.
