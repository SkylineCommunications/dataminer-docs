...
## DataMiner applications vs. sample applications

dataminer.MediaOps offers two types of applications: those created by Skyline and designed for minimal use "as is" with minimal configuration (DataMiner applications), and sample applications provided for DevOps teams as illustrative examples (sample applications).

### DataMiner applications

DataMiner applications are intended to be used as they are and will continuously evolve with releases that enhance the user experience and features. DataMiner users can obtain copies of these applications and customize them according to their requirements. However, users who choose to customize the applications will not automatically receive updates to the main DataMiner application.
...
## Applications included in the dataminer.MediaOps package
