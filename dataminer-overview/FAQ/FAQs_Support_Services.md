...
- **What happens when my renewal of my support plan is overdue (Perpetual-Use plan only)?**
  ...
  By default, support plan contracts renew automatically every year, unless they have been stopped by the user in advance of the anniversary date of the agreement (for more details, see [Data protection](xref:Support_services_agreement#pricing---term).
