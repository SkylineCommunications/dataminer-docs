...
- **DataMiner DevOps Professional**: For the appointed resources, subscribing to the DataMiner DevOps Professional program is highly recommended.

  <!-- Comment: xref to DataMiner DevOps Professional program when added to docs -->
