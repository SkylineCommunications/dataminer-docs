...
**Remote Access** consisting of **Remote app access**, **Remote Cube access** and **Remote User-Defined API access** gives you the ability to access your environment from anywhere. Via Remote app access (HTML), accessible on dataminer.services, you can go to all the low-code apps created in your environment. Especially handy is the Monitoring app: a lightweight version of Cube. In addition to this, Remote Cube access allows secure and effortless remote access to your entire Cube environment without the need for a VPN connection.
