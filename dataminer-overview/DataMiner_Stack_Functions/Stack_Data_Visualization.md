...
> - See also [Kata #3: Build your first low-code app](https://community.dataminer.services/video/kata-3-build-your-first-low-code-app/) on DataMiner Dojo ![Video](~/user-guide/images/video_Duo.png)
> - See also [Kata #7: Pages, panels and headers in a low-code app](https://community.dataminer.services/video/kata-7-pages-panels-and-headers-in-a-low-code-app/) on DataMiner Dojo ![Video](~/user-guide/images/video_Duo.png)
> - See also [Kata #8: Actions and events in a low-code app](https://community.dataminer.services/video/kata-8-actions-and-events-in-a-low-code-app/) on DataMiner Dojo ![Video](~/user-guide/images/video_Duo.png)
