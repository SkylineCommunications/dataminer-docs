...
With this connector, information can be gathered and viewed from the **Check Point 1100 Firewall Virtual Switch**.

## About

This connector is used to interface with the **Check Point 1100 Firewall Virtual Switch**. It uses SNMPv3 to communicate with the device.
