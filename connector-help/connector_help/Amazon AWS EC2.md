...
- **IP address/host**: [https://ec2.**\#REGION#**.amazonaws.com](https://ec2./#REGION%23.amazonaws.com)For example, for Europe (Frankfurt): [https://ec2.**eu-central-1**.amazonaws.com](https://ec2.eu-central-1.amazonaws.com/)
