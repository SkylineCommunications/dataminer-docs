...
The PacketLight PL-2000M is an advanced multi-protocol, multi-rate muxponder. This connector is used to monitor/control this device via SNMP.
...
This page contains the **Events, Generic Events, Event Inventory** and **OPT APS Traps** tables. These tables list the traps supported by the connector that have been received.
