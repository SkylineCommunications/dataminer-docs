---
uid: Connector_help_Meinberg_LANTIME_IMS-ESI
---

# Meinberg LANTIME IMS-ESI
...
An ESI card is, like the MRI card, dedicated to one specific clock module and can be installed in both ESI and MRI slots.
