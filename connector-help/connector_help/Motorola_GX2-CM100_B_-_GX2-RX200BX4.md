...
The **Motorola GX2-CM100 B - GX2-RX200BX4** driver is an SNMP-based driver used to monitor and configure the **Motorola GX2-RX200BX4**.

## About

This driver provides a monitoring interface for the **Motorola GX2-RX200BX4** module.
