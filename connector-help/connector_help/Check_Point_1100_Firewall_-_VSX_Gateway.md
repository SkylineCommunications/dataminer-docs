...
With this driver, information can be gathered and viewed from the **Check Point 1100 Firewall VSX Gateway**.

## About

This driver is used to interface with the **Check Point 1100 Firewall VSX Gateway**. It uses SNMPv3 to communicate with the device.
