---
uid: Connector_help_Meinberg_LANTIME_IMS-GNS
---

# Meinberg LANTIME IMS-GNS

The **GNS** is a central clock module for the Meinberg IMS platform. The multi GNSS receiver can use an external antenna to receive GPS, Galileo, GLONASS, and Beidou satellite signals, decode them and use them as a reference source for the integrated, oscillator-based hardware clock. In addition to synchronizing with the GNSS systems, the GNS clock module accepts a wide range of input references when combined with IMS input cards.
...
| 1.0.1.x   | Compatible with mbgNMS 1.1.x. | 1.0.0.1      | \-                                                                                              |
