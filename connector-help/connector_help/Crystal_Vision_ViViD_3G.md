...
The Crystal Vision ViViD 3G connector makes it possible to monitor and control a specific Crystal Vision ViViD 3G card. In addition, this connector is able to control the main features of this device: RGB/YUV gains, full vertical and horizontal timing and cross-locking.
