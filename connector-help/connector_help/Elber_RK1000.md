...
The Elber RK1000 driver can be used by broadcast operators in transmission netwerks for the DVB-ASi signal distribution over satellite or terrestrial networks as well in studio environments for the routing or the distribution of SDI/HD/3G-SDI/DVB-ASI signals. This driver is composed by a basic 3U 19" chassis that can host up to 10 hot-swappable modules, allowing an easy maintenance and stock management.

## About

This driver exports driver of type CO02 and creates elements for each card in it's chassis. Data is polled via **SNMP** and traps are used.
