---
uid: Connector_help_Lawo_Madi4_MKII
---

# Lawo Madi4 MKII

This connector is used to monitor the Lawo Madi4 MKII, an audio processor.
...
- Interface connection:
  ...
  - **IP port**: The IP port of the destination (default: *9009*).
