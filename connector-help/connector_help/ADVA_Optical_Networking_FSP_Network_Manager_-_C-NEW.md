---
uid: Connector_help_ADVA_Optical_Networking_FSP_Network_Manager_-_C-NEW
---

# ADVA Optical Networking FSP Network Manager - C-New

The ADVA Optical Networking FSP Network Manager - C-New is a type of client card that connects to the [ADVA Optical Networking FSP Network Manager](xref:Connector_help_ADVA_Optical_Networking_FSP_Network_Manager).
