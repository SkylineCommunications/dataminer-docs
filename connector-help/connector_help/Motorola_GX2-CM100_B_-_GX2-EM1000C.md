...
The **Motorola GX2-CM100 B - GX2-EM1000C** driver is an SNMP-based driver used to monitor and configure the **Motorola GX2-EM1000C**.

## About

This driver provides a monitoring interface for the **Motorola GX2-EM1000C** module.
