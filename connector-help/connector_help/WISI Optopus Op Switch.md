...
The **WISI Optopus Op Switch** LX60 is an optical redundancy switch card. With this SNMP driver, you can control and monitor the parameters of the card incorporated in the chassis of the **WISI Optopus**.
