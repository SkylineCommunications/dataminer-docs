...
The **Axon ACP HES20** driver can be used to display and configure information related to this device.
...
This element using this driver can be automatically created by the parent element using the **Axon ACP** driver, but it can also be a standalone element.
