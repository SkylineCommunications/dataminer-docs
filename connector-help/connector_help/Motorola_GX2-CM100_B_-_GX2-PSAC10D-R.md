...
The **Motorola GX2-CM100 B - GX2-PSAC10D-R** driver is an SNMP-based driver used to monitor and configure the **Motorola GX2-PSAC10D-R**.

## About

This driver provides a monitoring interface for the **Motorola GX2-PSAC10D-R** module.
