---
uid: Connector_help_ADVA_Optical_Networking_FSP_Network_Manager_-_C-N
---

# ADVA Optical Networking FSP Network Manager - C-N

The ADVA Optical Networking FSP Network Manager - C-N is a type of client card that connects to the [ADVA Optical Networking FSP Network Manager](xref:Connector_help_ADVA_Optical_Networking_FSP_Network_Manager).
