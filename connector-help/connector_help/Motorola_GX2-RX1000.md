...
The **Motorola GX2-RX1000** driver is an SNMP-based driver used to monitor and configure the **Motorola GX2-RX1000**.

## About

This driver provides a monitoring interface for the **Motorola GX2-RX1000** chassis.
