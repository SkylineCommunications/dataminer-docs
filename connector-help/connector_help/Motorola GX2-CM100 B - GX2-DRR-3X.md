...
The **Motorola GX2-CM100 B - GX2-DRR-3X** driver is an SNMP-based driver used to monitor and configure the **Motorola GX2-DRR-3X**.

## About

This driver provides a monitoring interface for the **Motorola GX2-DRR-3X** module.
