...
The element can be automatically generated by the connector **Axon ACP Manager** or can be added manually to monitor a single card without information about the frame.
...
This element can be automatically created by the element using the **Axon ACP Frame Manager** connector, but can also be used as standalone connector.
