---
uid: Connector_help_WISI_Optopus_OP_Amplifier
---

# WISI Optopus OP Amplifier

The **WISI Optopus OP Amplifier** LX30 is an optical amplifier card. With this SNMP connector, you can control and monitor the parameters of the card incorporated in the chassis of the **WISI Optopus**.
...
|-----------|------------------------|
| 1.0.0.x   | APPL_LX30 1.0.0.20     |
| 1.0.1.x   | APPL_LX30 1.0.0.20     |
...
- **OP Amplifier**: General information about the card.
- **Amplifiers**: Details about the amplifier laser.
