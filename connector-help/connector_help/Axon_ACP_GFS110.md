---
uid: Connector_help_Axon_ACP_GFS110
---

# Axon ACP GFS110

The GFS110 is a 3 Gb/s, HD, SD frame synchronizer with optional audio shuffler.

The **Axon ACP GFS110** connector can be used to display and configure information related to this device.
