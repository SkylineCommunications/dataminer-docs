...
This exported driver shows data from a **VS909** card in a **Nevion Ventura VS103** chassis.

## About

This driver is automatically generated by the driver **Nevion Ventura VS103**, range 2.0.0.x (as Nevion Ventura VS909), 2.0.1.x and 2.0.2.x.
...
A DVE using this protocol is **automatically created** by an element using the **Nevion Ventura VS103** driver that polls a device with a **VS909** module inserted.
