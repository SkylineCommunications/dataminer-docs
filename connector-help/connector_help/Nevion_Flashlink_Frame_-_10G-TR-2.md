...
This exported driver shows data from a **10G-TR-2** module in a Nevion Flashlink frame. This module is a bi-directional 10 Gbps optical transponder. It is used to bridge between different optical systems.
