---
uid: Connector_help_Sony_PWS-110SC1-MKS-X2700
---
...
This connector is designed to monitor the state of a Vision Mixer System Interface Unit, which can be connected to a Sony PWS-110SC1, using **SNMP** communication.
