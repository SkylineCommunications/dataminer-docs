---
uid: Connector_help_FOR-A_FRC-9100
---
...
|----------------------|------------------|--------------|-------------------|
| 1.0.0.x \[SLC Main\] | Video support    | \-           | \-                |
...
The current version only supports video. Audio is not supported yet, as FOR-A has not yet made audio support available through SNMP for the current device model.
