...
The **WISI Tangram GT31** driver is used to monitor and control the Tangram GT 31 W module. The GT 31 W module allows you to add up to 4 DVB- transport streams per module to your network.

## About

This driver is automatically generated by the driver WISI Tangram, range 1.0.1.x and 1.1.0.x.
