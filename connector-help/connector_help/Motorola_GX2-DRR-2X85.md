...
The **Motorola GX2-DRR-2X85** driver is an SNMP-based driver used to monitor and configure the **Motorola GX2-DRR-2X85**.

## About

This driver provides a monitoring interface for the **Motorola GX2-DRR-2X85** chassis.
