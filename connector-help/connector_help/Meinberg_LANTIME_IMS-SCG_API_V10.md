---
uid: Connector_help_Meinberg_LANTIME_IMS-SCG_API_V10
---

# Meinberg LANTIME IMS-SCG API V10

The **SCG** (Studio Clock Generator) generates various word clock or AES11 signals for studio applications.
