---
uid: Connector_help_Meinberg_LANTIME_IMS-FDM
---

# Meinberg LANTIME IMS-FDM

The **FDM** (Frequency Deviation Monitor) is designed to calculate and monitor the frequency and its deviation in 50/60 Hz powerline networks.
