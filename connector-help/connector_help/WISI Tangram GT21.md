...
The **WISI Tangram GT21** driver is used to monitor and control the Tangram GT21W module. The GT21W is a high-performance edge, which allows you to add up to 6 services in PAL/SECAM/NTSC format per module to your network.

## About

This driver is automatically generated by the driver WISI Tangram range 1.0.0.x and 1.0.1.x.
