...
There is also a **Create Output Mux** subpage that allows the creation of a new Output Multiplexer.

### Multiplexers

The **Multiplexers** page displays the **Multiplexers** and **Tables** tables. The **Multiplexers** table has information related with every multiplexer and also is used for the creation of new multiplexers. The **Tables** tables has information related to Video tables and the corresponded ID of PIDs, PMT and PCR.
