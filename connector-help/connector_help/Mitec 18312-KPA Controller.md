---
uid: Connector_help_Mitec_18312-KPA_Controller
---

# Mitec 18312-KPA Controller

The 18312-01 MD 1:3 redundant switch is a microcontroller-based unit designed to monitor and control a switching/combining network, consisting of:
...
|-----------|-----------------------------------------------------|
| 1.0.0.x   | Configuration Version: 1.00Software Version: 2.23.1 |
