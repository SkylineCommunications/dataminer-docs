...
- Port 5100 should be open for incoming traffic from the internal network for the Remote Log collection to work correctly. More information on this endpoint can be found [here](xref:Custom_cloud_endpoint_configuration).
