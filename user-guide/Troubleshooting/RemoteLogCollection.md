...
The packages generated by the Log Collector tool are automatically transferred to a secure storage in the cloud, so that our experts have immediate access to the packages.
