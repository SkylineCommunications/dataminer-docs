...
> [!NOTE]
> From DataMiner 10.3.11/10.3.0 [CU8] onwards<!--RN 37401-->, when changes are made to the *SLCloud.xml*, *nats-server.config*, or *nas.config* files, the old version of that file is saved in the *C:\Skyline DataMiner\Recycle Bin* folder.
