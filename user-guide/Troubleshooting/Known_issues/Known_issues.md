...
|--|--|--|--|
| [Process crash when trying to connect to MySQL database](xref:KI_MySQL_Unhandled_Exception) | from DataMiner 10.3.0[CU14]/10.4.0[CU2]/10.4.5 <br>onwards | | March 22, 2024 |
