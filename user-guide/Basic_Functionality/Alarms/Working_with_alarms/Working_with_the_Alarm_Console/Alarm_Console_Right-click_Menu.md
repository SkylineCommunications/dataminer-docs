...
- **Like**: Allows you to provide positive feedback on a suggestion event or alarm generated by behavioral anomaly detection. See [Providing feedback on behavioral anomalies](xref:Behavioral_anomaly_detection#providing-feedback-on-behavioral-anomalies).

- **Dislike**: Allows you to provide negative feedback on a suggestion event or alarm generated by behavioral anomaly detection. See [Providing feedback on behavioral anomalies](xref:Behavioral_anomaly_detection#providing-feedback-on-behavioral-anomalies).
