...
> [!NOTE]
> Prior to DataMiner 10.3.0 [CU15]/10.4.0 [CU3]/10.4.6<!--RN 39415-->, ensure *Behavioral Anomaly Detection* is enabled on top of *Proactive Cap Detection* in *System Center* > *System settings* > *Analytics Config* to get access to the *Suggestion events* tab displaying the notifications generated by the proactive cap detection feature.
