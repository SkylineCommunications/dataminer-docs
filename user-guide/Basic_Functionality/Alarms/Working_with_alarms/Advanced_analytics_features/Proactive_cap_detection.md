...
- From DataMiner 10.3.0 [CU18]/10.4.0 [CU6]/10.4.9 onwards<!--RN 39707-->, suggestion events displaying the notifications generated by the proactive cap detection feature for [virtual functions](xref:srm_definitions#virtual-function) are generated on the parent element. Prior to DataMiner 10.3.0 [CU18]/10.4.0 [CU6]/10.4.9, these suggestion events are generated on the child element.

- Proactive cap detection suggestion events generated for [dynamic virtual elements](xref:Dynamic_virtual_elements) are generated on the child element.
