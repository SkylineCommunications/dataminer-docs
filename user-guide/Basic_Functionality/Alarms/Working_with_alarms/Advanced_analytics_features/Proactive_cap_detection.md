...
The value of the suggestion event mentions what kind of issue is expected, e.g. the predicted breaches of critical normal alarm thresholds. The value also mentions "Predicted Critical High" or "Predicted Critical Low".
