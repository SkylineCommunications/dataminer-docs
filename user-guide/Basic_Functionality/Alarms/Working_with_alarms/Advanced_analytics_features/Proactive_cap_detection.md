...
Do note that the [Trend Prediction](xref:Working_with_trend_predictions) feature needs to be enabled as well in order to have the automatic notifications for predicted critical low or critical high values generated by proactive cap detection.
