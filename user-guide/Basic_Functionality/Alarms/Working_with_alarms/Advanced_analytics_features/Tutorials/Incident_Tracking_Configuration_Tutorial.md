...
- DataMiner 10.2.0/10.1.4 or higher with [Storage as a Service (STaaS)](xref:STaaS) (recommended) or a [self-hosted Cassandra database](xref:Supported_system_data_storage_architectures).
