...
1. Deploy the Catalog item to your DataMiner Agent by clicking the *Deploy* button.
   ...
   This will create 13 elements under the *Catalog > Augmented Operations* > *Incident Tracking Tutorial* view. It will also create four Automation scripts. The names of all added elements and scripts starts with *Incident Tracking Tutorial*.
