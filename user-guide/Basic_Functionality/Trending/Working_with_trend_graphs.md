...
- A light bulb icon in the top-right corner to add parameters related to those shown in the trend graph (from DataMiner 10.2.12/10.3.0 onwards).<br/>
Learn more about this feature here: [Adding related parameters to a trend graph](xref:Adding_related_parameters_to_a_trend_graph).
