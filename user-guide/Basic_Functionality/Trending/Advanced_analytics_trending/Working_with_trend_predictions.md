...
- **Full-term prediction** is also displayed with long dashes (Available from DataMiner 10.0.11 onwards).
  A full-term prediction is generated by a model fit on an aggregated set of 1-hour trend data points. This type of trend prediction extrapolates the global trend in the data to the future.
