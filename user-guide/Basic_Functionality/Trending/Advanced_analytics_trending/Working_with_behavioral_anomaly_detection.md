...
> - If a very high number of behavioral change points are detected in a short period, detection of behavioral anomalies is temporarily disabled to avoid unreliable results. A notification will be displayed in this case, which will disappear again 2 hours after the change point flood has been resolved.
