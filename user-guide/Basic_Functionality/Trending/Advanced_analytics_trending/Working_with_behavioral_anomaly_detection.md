...
> [!NOTE]
>
> - This feature requires a [self-hosted Cassandra-compatible database](xref:Supported_system_data_storage_architectures). At present, suggestion events are not yet supported with [Storage as a Service](xref:STaaS).
