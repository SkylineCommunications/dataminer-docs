...
- *Enabled*: Allows you to activate or deactivate this feature. However, note that disabling the feature will influence the trend graph insights generated by [relation learning](xref:Working_with_relation_learning).
