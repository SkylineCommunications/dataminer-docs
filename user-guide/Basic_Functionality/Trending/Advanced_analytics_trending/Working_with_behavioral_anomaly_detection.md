...
- From DataMiner 10.4.11/10.5.0 onwards<!--RN 39945-->, you can [provide feedback on suggestion events and alarms](xref:Providing_feedback_on_behavioral_anomalies) generated by behavioral anomaly detection. Based on this feedback, DataMiner will gradually learn when to trigger a suggestion event or an alarm.
