...
> - From DataMiner 10.3.0 [CU9]/10.3.12 onwards<!--RN 37571-->, if a trend change is detected but the trend returns to the previous state within an hour, the behavioral change will be labeled as a level shift rather than a trend change.
