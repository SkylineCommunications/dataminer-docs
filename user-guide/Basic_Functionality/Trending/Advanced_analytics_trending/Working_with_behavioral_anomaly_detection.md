...
- From DataMiner 10.3.0 [CU20]/10.4.0 [CU8]/10.4.11 onwards<!--RN 39945-->, you can [provide feedback on suggestion events](xref:Behavioral_anomaly_detection#providing-feedback-on-suggestion-events) generated by behavioral anomaly detection. Based on this feedback, DataMiner will gradually learn when to trigger a suggestion event or an alarm.
