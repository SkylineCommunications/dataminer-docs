...
- From DataMiner 10.3.10/10.4.0 onwards<!-- RN 36971 -->, you can right-click an element in the list and select to edit, delete, or duplicate the element. These options are not available for DVE child elements.
