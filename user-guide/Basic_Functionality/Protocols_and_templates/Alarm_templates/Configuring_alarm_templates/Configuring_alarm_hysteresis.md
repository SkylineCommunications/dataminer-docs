...
> - Hysteresis in combination with conditions on the same parameter is not supported. In future Cube versions a warning can appear about this limitation (as long as it's not fully supported by the Core).
