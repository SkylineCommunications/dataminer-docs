...
> - From DataMiner 10.3.4/10.4.0 onwards, interactions between DataMiner web apps and Cube (e.g. opening an element card) now also work when those web apps are embedded in Microsoft Edge (WebView2). Prior to DataMiner 10.3.4/10.4.0, this functionality was already supported when using [Chromium](#usechrome) to display web apps. <!-- RN 35655 -->
