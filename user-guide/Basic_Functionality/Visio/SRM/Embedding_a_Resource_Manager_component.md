...
| ComponentOptions | EnableFollowMode | Activates the follow mode. This will make the timeline move along with the current time. When you navigate away from the line that represents now and the follow mode is activated, then the follow mode will be paused. This will be activated automatically again when you navigate back in view of the line that represents now. |
