...
> - Viewing a list of bookings will only be possible if the DMS has the necessary licenses and uses an [Elasticsearch](xref:Deploying_the_Elasticsearch_database) database.
