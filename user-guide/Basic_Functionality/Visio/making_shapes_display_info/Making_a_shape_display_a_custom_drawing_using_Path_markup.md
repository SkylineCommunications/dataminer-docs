...
- **YAxisUp**: false or true. If false, the 0,0 coordinates will be in the top left corner, similar to image editing programs such as Inkscape or Illustrator. If true, the 0,0 coordinates will be in the bottom left corner, as typically used in data visualization graphics.
