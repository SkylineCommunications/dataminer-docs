...
> [!TIP]
> See also: <https://community.dataminer.services/video/visio-customizing-mouseover-effects-on-a-view-object/>
...
> - For an example, see [Ziine](xref:ZiineDemoSystem) > *[Linking Shapes]* view > *[controls > BUTTON]* page.
