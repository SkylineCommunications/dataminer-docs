...
This BPA test is available from DataMiner 10.3(CU11)/10.4.1 onwards.<!-- RN 37110 --> You can [run it in System Center](xref:Running_BPA_tests) on the *Agents > BPA* tab.
