...
Prior to DataMiner 10.4.12/10.5.0, this BPA test is called "Minimum Requirements Check".-->
...
- Name: Minimum Requirement Checker <!-- DataMiner Agent Minimum Requirements -->
