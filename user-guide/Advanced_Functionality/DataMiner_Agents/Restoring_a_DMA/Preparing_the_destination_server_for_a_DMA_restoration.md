...
- Clear the configuration of an existing DMA using the [SLReset factory reset tool.](https://community.dataminer.services/documentation/factory-reset-tool/) This is highly recommended over manually clearing the configuration; however, it is only possible if the DMA is using DataMiner 10.0.12 or higher.
