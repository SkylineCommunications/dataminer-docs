...
| HTTP(S) | 5100/tcp (internal) | [Cloud endpoint](xref:Custom_cloud_endpoint_configuration) hosted in [DataMiner CloudGateway](xref:DataMinerExtensionModules#cloudgateway) (by default enabled from DataMiner CloudGateway 2.10.0 onwards) 
