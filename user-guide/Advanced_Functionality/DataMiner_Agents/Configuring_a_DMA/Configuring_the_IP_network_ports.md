...
| HTTP(S) | 5100/tcp | Cloud Proxy hosted in [DataMiner CloudGateway](xref:DataMiner_Extension_Modules#cloudgateway) (by default enabled from DataMiner CloudGateway V2.9.6 onwards) |
