...
| HTTP(S) | 5100/tcp (internal) | Cloud endpoint hosted in [DataMiner CloudGateway](xref:DataMinerExtensionModules#cloudgateway) (by default enabled from DataMiner CloudGateway V2.9.6 onwards) |
