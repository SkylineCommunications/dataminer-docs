...
description: A DMS can be configured to send out email notifications and reports via an SMTP server. You can either configure this directly in DataMiner.xml or use the SLNetClientTest tool.
---
