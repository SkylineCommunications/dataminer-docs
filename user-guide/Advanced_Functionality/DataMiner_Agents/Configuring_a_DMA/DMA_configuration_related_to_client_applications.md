...
1. Select which client versions should be used:
   ...
   - **Force a specific version**: This will force users to always use a particular Cube version, which you will need to select on the server when you choose this option.
...
> - By default, this is configured for the entire DMS. If you select the checkbox *Allow individual agent configuration*, you can configure different client version settings per DMA instead. However, this is not recommended.
