...
> [!NOTE]
> Prior to DataMiner 10.3.0 [CU13]/10.4.0 [CU1]/10.4.4, you also need the [Modules > Automation > UI Available](#modules--automation--ui-available) to execute Automation scripts<!--RN 38529-->.
