...
With recent DataMiner versions, when running Cassandra in a *Single node* configuration, **Cassandra 3.11** is installed by default. This is also the minimum supported version. Cassandra 4.0 is also supported.
