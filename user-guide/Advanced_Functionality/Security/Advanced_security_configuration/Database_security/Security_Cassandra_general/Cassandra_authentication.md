...
You can do so by executing the following queries (using *cqlsh* in Linux environment, DevCenter in Windows, Query Executor in DataMiner Cube, or your preferred query tool):
