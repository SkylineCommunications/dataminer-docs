...
[!TIP] We also provide a PowerShell script to modify the Cassandra service user. The *Modify-CassandraServiceUser* Powershell script is available here [here](https://github.com/SkylineCommunications/Modify-CassandraServiceUser) 
