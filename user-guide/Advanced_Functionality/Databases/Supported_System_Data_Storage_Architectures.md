...
> [!IMPORTANT]
> From DataMiner 10.3.0 [CU0]/10.3.2 onwards, instead of a Cassandra cluster, you can use the [Amazon Keyspaces Service on AWS](xref:Amazon_Keyspaces_Service) and instead of an Elasticsearch cluster, you can use an on-prem [OpenSearch cluster](xref:OpenSearch_database) or the [Amazon OpenSearch Service on AWS](xref:Amazon_OpenSearch_Service)
