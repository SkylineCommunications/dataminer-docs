...
> [!TIP]
> See also: [Configuring how alarm history slider data are kept in a Cassandra database](xref:DB_xml#configuring-how-alarm-history-slider-data-are-kept-in-a-cassandra-database)
...
## [From DataMiner 9.5.5 onwards](#tab/tabid-2)
...
1. Go to the folder *C:\\Skyline DataMiner\\Database* (or *C:\\Skyline DataMiner* prior to DataMiner 9.5.8) and open the file *DBMaintenanceDMS.xml.*

1. Within the *\<TimeToLive>* tag, make sure there is a TTL tag with the following attributes:
...
1. In the *HistorySlider.TimeToKeep* tag, specify a number of seconds between 0 and 2,147,483,647:
