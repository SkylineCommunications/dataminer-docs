...
1. Specify the following database settings for the Cassandra nodes:
   ...
   - **DB server**: The IP addresses or hostnames of the nodes, separated by commas. From DataMiner 10.3.0/10.3.3 onwards, you can specify an IP address with a custom port, e.g `10.5.100.1:5555`. If no port is provided, port 9042 will be used by default. <!-- RN 34590 -->
...
1. Specify the following database settings, depending on your DataMiner version:
   ...
   - **DB Server**: The name or IP address of the server that hosts the database. From DataMiner 10.3.0/10.3.3 onwards, you can specify an IP address with a custom port, e.g `10.5.100.1:5555`. If no port is provided, port 9042 will be used by default. <!-- RN 34590 -->
