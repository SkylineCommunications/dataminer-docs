...
It is possible that a cluster is not formed.

On the cluster manager and data nodes in the /var/log/opensearch/NameOfYourCluster.log the below exceptions occurs:
...
1. Go to the data folder as specified in the opensearch.yml file and delete the folder called *nodes* and every file below this folder by using the following command:
