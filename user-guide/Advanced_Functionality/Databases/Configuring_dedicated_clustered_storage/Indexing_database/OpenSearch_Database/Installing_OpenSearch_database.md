...
1. When you have finished the TLS configuration and set a different hash for the admin user, restart OpenSearch. You can use the following command for this.
