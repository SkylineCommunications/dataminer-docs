...
| Execute  | string                                 | The action to be executed.<br> The same syntax is used as for Visio shapes:<br> - *Script:ScriptName\|Dummies\|Parameters\|Memories\|Tooltip\|Options*
> - *Set\|DmaID/ElementID\|ParameterID:TableRowKey\|NewValue\|Options*
> Inside this string, the following placeholders can be used:<<br> -  *\[StartTime\]*: The timestamp of the start of the selected range.<<br> -  *\[StopTime\]*: The timestamp of the end of the selected range. |
