...
2. In the *Advanced* options at the top of the card, optionally change the masking options:
...
6. Select each backup element in turn to configure it using the options on the right side of the card:
