...
> [!NOTE]
> If an alarm update does not change the severity of the alarm, from DataMiner 10.0.12 onwards, the alarm record can be combined with the previous records into one consolidated event. This behavior can be enabled in the MaintenanceSettings.xml file. For more information, see [AlarmSettings.MustSquashAlarms](../../part_7/SkylineDataminerFolder/MaintenanceSettings_xml.md#alarmsettingsmustsquashalarms).
