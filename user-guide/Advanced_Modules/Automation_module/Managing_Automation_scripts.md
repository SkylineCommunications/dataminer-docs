...
The Automation module also includes scripts that have been deployed as part of packages from the Catalog. From DataMiner Cube 10.4.0 [CU16]/10.5.0 [CU4]/10.5.7 onwards<!-- RN 42773 -->, the description of such scripts will indicate the name and version of the package that was used to deploy them. You can make changes to such scripts, but that does mean you are customizing the deployed package. In that case, the description of the script will display "[Customized]" in front of the package name. To restore the original script, you can redeploy the package.
