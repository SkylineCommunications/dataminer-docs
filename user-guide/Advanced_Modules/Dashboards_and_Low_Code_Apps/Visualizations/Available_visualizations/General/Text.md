...
- In the *Component* > *Settings* tab, add the text in the *Text* box.
  ...
  > [!NOTE]
  > From DataMiner 10.3.0 [CU14]/10.4.0 [CU2]/10.4.5 onwards<!--RN 38993-->, you can link this component to a feed by [dynamically referencing feed values](xref:Feed_Link) in the text. However, note that the text is limited to 200,000 characters.
