...
Available from DataMiner 10.3.0 [CU16]/10.4.0 [CU4]/10.4.7 onwards<!--  RN 39555 -->. This basic control allows users to enter text that will then be available as string data in the dashboard or low-code app. The string data can be used by queries and by script parameters in low-code app actions. This string data can also be cleared with an "x" button available in the input.
