...
At present, this feed can only be used as a filter feed for a component displaying a [GQI query](xref:Configuring_GQI_feeds) result. It will function as a refresh trigger for that query.
