...
> [!NOTE]
> Feeds can often contain multiple values and therefore the value(s) will be wrap in a JSON array. To be consistent, this will also be the case when only a single value is fed.
