...
> [!IMPORTANT]
> Ad hoc data sources are identified by a combination of their script name, library name and class name. Changing any of these values will cause existing queries to stop working because the script can no longer be found with the identifier they are using.
