...
- All created queries are listed in alphabetical order in the *Queries* section of the *Data* pane. Immediately after creating a query, it may appear last in the list, but it will be displayed in alphabetical order after collapsing and expanding the *Queries* section or reopening the app. Prior to DataMiner 10.4.0 [CU14]/10.5.0 [CU2]/10.5.5<!--RN 42452-->, queries are listed in the order they were created.
