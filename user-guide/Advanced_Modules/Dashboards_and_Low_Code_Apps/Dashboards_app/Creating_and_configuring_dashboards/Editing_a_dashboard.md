...
1. In the dashboard header bar, click the pencil icon.
   ...
   - To change the data input for an existing component, drag the data from the data panel to the component. For more information, see [Adding data to a component](xref:Adding_data_to_component).
