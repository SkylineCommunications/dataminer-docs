...
1. In the dashboard header bar, click the pencil icon.
   ...
   - To change the data input for an existing component, drag the data from the data panel to the component. For more information, see [Applying a data source](xref:Apply_Data_Source).
