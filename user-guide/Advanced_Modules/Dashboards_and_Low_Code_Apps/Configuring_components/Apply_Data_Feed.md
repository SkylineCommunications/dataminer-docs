...
1. **Drag the compatible data feed** onto the component.
   ...
   - From DataMiner 10.3.0 [CU21]/10.4.0 [CU9]/10.4.12 onwards<!--RN 41039-->, data can also be provided by a **variable**. [Variables](xref:Variables) are reusable data objects that persist across sessions and can be dynamically updated.
