...
- .NET 8 ([ASP.NET Core 8.0 Runtime](https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/runtime-aspnetcore-8.0.8-windows-hosting-bundle-installer)) must be installed on the server where you want to install Data Aggregator.
