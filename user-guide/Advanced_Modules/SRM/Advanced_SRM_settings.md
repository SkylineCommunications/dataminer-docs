...
| SkipDcfLinks | When a booking starts, DCF connections are set between the function DVEs of the assigned resource. They get deleted again when the booking finishes. From DataMiner 10.4.7 onwards, this setting is available to disable this start and end action. The default value is false. |
