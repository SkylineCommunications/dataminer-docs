...
> - From DataMiner 10.0.0/10.0.2 onwards, DataMiner SRM also requires an Elasticsearch database. See [Elasticsearch database](xref:Deploying_the_Elasticsearch_database).
