...
The *Occupancy* tab shows a timeline that illustrates when particular resources are reserved. Like in the main timeline tab of Scheduler or in the Bookings module, here too you can activate follow mode or zoom to a particular time span via the right-click menu.
