...
9. Under *Actions*, click *Add* and select which action should be executed:
    ...
    | Upload report to FTP           | Specify an FTP server, and a report or dashboard to upload to it. For more information and example configurations, see [Upload report to FTP](xref:Upload_report_to_FTP).                                   |
    | Upload report to shared folder | Specify a shared folder, and a report or dashboard to upload to it. For more information and example configurations, see [Upload report to shared folder](xref:Upload_report_to_shared_folder).             |
