...
To do this, define your API exactly as explained under the [Creating an API definitions and token(s)](xref:UD_APIs_Define_New_API#creating-an-api-and-tokens-in-automation), but next to *Method to be executed*, select *Run method*.
