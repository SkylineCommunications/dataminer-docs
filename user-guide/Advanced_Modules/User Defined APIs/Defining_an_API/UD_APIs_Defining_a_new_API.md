...
- The `ApiTriggerInput` is an object that contains information about the API trigger. It has the following properties:
  ...
  | Context | [ApiTriggerContext](#apitriggercontext) | Contains properties with info concerning the request. Available from DataMiner 10.3.9/10.4.0 onwards. <!-- RN 37015 --> |
