...
- The `ApiTriggerInput` is an object that contains information about the API trigger. It has the following properties:
  ...
  | TokenId | `ApiTokenId` | Contains the ID of the [ApiToken](xref:UD_APIs_Objects_ApiToken) with which the API is triggered. Available from DataMiner 10.3.9/10.4.0 onwards<!-- RN 36856 -->. |
