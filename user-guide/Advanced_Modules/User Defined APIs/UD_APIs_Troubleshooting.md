...
- The folder `C:\Skyline DataMiner\Logging\SLUserDefinableApiManager.txt` contains logging related to the manager in SLNet that manages the CRUD actions on API tokens/definitions and the API triggers.
