...
> - It can happen that there are still history records being returned for a deleted DOM instance shortly after this instance is deleted. This time can vary depending on the history settings, the number of records, and the database performance.
