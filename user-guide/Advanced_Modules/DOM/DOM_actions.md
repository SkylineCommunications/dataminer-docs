...
> - Prior to DataMiner versions 10.5.2/10.5.0<!-- RN 41536 -->, a 'Script started' information event would be generated when the configured script was launched. This has since been disabled to reduce the load on the database.
