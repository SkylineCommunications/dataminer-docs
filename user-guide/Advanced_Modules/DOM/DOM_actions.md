...
> - Prior to DataMiner versions 10.5.2/10.5.0<!-- RN 41536 -->, a "Script started" information event is generated when the configured script is launched. To reduce the load on the database, this no longer happens from those DataMiner versions onwards.
