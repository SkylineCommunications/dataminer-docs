...
>
> When storing `string` values, the value cannot contain more than 32,766 UTF-8 bytes from DataMiner 10.4.12/10.5.0 onwards, so the max amount of characters will have to be lower.<!-- RN 39496 -->
