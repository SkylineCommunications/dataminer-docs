...
> [!NOTE]
> The most commonly used SLA protocol is *Skyline SLA Definition Basic*, which is available in the [Catalog](xref:About_Catalog). Note that versions of this protocol prior to 2.0.0.16 are no longer supported.
