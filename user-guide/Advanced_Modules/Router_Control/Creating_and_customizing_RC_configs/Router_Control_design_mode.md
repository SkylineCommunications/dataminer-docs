...
| ![](~/user-guide/images/router_control_restore.png) | Restore | Load a configuration that is stored in a compressed XML file on the client machine.<br> Click the downward triangle next to the button when hovering over this button to select the configuration from a drop-down list. |
