...
> - If you use a private KML file, your DataMiner Agent (or at least the /API) must be publicly accessible, so that Google Maps can download the KML file from the DataMiner Agent and render it.
