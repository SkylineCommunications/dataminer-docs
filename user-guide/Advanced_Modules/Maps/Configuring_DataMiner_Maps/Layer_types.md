...
> - If you use a private KML file, then your DataMiner (at least the /API) must be publicly accessible, so that Google Maps can download the KML file from the DataMiner agent and render it.
