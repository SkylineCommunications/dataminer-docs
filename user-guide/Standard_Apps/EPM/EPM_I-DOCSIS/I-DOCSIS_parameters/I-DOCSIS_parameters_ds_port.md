...
- **Number CM DOCSIS Other**: Calculated. The number of CMs served by the DS port for the other DOCSIS versions.
...
- **Percentage Utilization**: Calculated. The average utilization of all DS channels associated with the DS port.
