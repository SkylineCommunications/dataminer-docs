...
- **US QAM Ch Time Offset**: Calculated. The Upstream Time Offset for the given CM-channel combination as calculated by DataMiner.
  ...
  Calculated as follows for DOCSIS v3: Time Offset = Upstreams ticks * (6.25/(64*256)) * (97.6 / 1000).
  
  Calculated as follos for other DOCSIS version: Time Offset = Upstreams ticks * (6.25/64) * (97.6 / 1000).

  DOCSIS v3

  - OID: 1.3.6.1.4.1.4491.2.1.20.1.4.1.10.

  Other DOCSIS version:
