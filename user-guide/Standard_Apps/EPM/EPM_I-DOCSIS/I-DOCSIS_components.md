...
- **EPM_I_DOCSIS_GQI_GET_ALL_CM_DATA**: Script used to retrieve all CM related data in Dashboards using GQI.
- **EPM_I_DOCSIS_GQI_GET_ALL_DS_QAM_DATA**: Script used to retrieve all DS QAM Channel related data in Dashboards using GQI.
- **EPM_I_DOCSIS_GQI_GET_ALL_US_QAM_DATA**: Script used to retrieve all US QAM Channel related data in Dashboards using GQI.
- **EPM_I_DOCSIS_GQI_GET_ALL_CM_DS_QAM_DATA**: Script used to retrieve all CM DS QAM Channel related data in Dashboards using GQI.
- **EPM_I_DOCSIS_GQI_GET_ALL_CM_US_QAM_DATA**: Script used to retrieve all CM US QAM Channel related data in Dashboards using GQI.
