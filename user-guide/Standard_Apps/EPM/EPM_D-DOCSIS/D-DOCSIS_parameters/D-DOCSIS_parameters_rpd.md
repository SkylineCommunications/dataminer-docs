...
- **Broadcast Video DEPI**: Calculated. The Broadcast Video DEPI, which is retrieved by looking for the RPD core with the same interface as the Nearcast interface to retrieve the address.
