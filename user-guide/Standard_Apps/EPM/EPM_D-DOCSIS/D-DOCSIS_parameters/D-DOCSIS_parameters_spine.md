...
- **Wavelength (Optics Details Table)**: The optics wavelength. Retrieved using the call "show controller optics \<opticsIndex>".
...
- **Expires (PIM Neighbors Table)**: Expires. Retrieved using the call "show pim neighbor".
