...
- Install [DataMiner IDP with Process Automation](Installing_DataMiner_IDP).
...
1. Launch the Process Automation Wizard, as explained in [Processes](Overview_of_the_IDP_app_UI#processes).
