...
For every resource that needs to be used with Service Orchestration, the necessary capabilities must be defined. If these are not configured for a resource, users will not be able to create bookings that make use of that resource.
