...
| GQI | Generic Query Interface. A special type of data feed for DataMiner dashboards and Low-Code apps.<br>See [Configuring GQI feeds](xref:Configuring_GQI_feeds). |
