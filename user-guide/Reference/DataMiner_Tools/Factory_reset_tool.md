...
> - The factory reset tool will disconnect the DMA from dataminer.services from DataMiner version 10.4.7/10.5.0 onwards. For versions prior to 10.4.7/10.5.0, the DMA will remain connected to dataminer.services even after a factory reset.
