...
> [!NOTE]
> From DataMiner 10.2.0 [CU11]/10.3.2 onwards, you are no longer obligated to place custom CollectorConfig XML files in the folder `C:\Skyline DataMiner\Tools\SLLogCollector\LogConfigs`, but can also place them in the `LogConfig` folder, which holds `SL_LogCollector.exe`. <!-- RN 34739 -->
