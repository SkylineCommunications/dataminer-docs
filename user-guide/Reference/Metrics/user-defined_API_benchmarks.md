...
- [Benchmark DataMiner 10.4.9](#benchmark-dataminer-1049)
- [Benchmark DataMiner 10.3.6](#benchmark-dataminer-1036)
...
| 4 | Max request rate | DMS | 80 requests per second, with a request duration of 13 ms | Script that receives 100 bytes and immediately returns it | Until 80 requests per second, the average response time remains 13 ms. Starting from 80 requests per second, the average response time increases. |

## Benchmark DataMiner 10.3.6
...
| 4 | Max request rate | DMS | 50 requests per second, with a request duration of 45 ms | Script that receives 100 bytes and immediately returns it | Until 50 requests per second, the average response time remains 45 ms. Starting from 50 requests per second, the average response time increases. |
