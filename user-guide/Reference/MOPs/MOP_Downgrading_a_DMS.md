...
1. Existing dashboards and low-code apps might not work anymore after downgrading. See [Downgrading the DataMiner web apps](xref:Upgrading_Downgrading_Webapps#downgrading-the-dataminer-web-apps).
