...
For certain DataMiner features, an additional indexing engine is required. This [Elasticsearch cluster](https://community.dataminer.services/expert-hub-elastic/) (link not working) comes with additional requirements. For these, we follow Elastics’s official [guidelines](https://www.elastic.co/guide/en/elasticsearch/guide/current/hardware.html).
