...
| Logger tables of type DirectConnection with a primary key | End of Engineering | See [Defining a logger table of type DirectConnection with a primary key](xref:AdvancedLoggerTablesDefiningDirectConnectionTable). | End of Support as of DataMiner version 10.7.x (Q4 2026). |
| [Radius authentication](xref:Configuring_RADIUS_settings) | End of Engineering | <!-- TBD --> | End of Support as of DataMiner version 10.7.x (Q4 2026). |
| Connectors: [dllName option in QAction options attribute](xref:Protocol.QActions.QAction-options#dllnamenamedll) | End of Engineering | <!-- TBD --> | End of Support as of DataMiner version 10.7.x (Q4 2026) |
| [Atlassian Crowd authentication](xref:Configuring_Atlassian_Crowd_settings#authenticating-dataminer-users-against-an-atlassian-crowd-server) | End of Engineering | <!-- TBD --> | End of Life to be confirmed. |
| Connectors: Display columns in tables | End of Engineering | See [displayColumn attribute](xref:Protocol.Params.Param.ArrayOptions-displayColumn) | End of Life to be confirmed. |
| Legacy reservations | End of Engineering | <!-- TBD --> | End of Life to be confirmed. |
| Connectors: action type ACT_RUN_SCRIPT | End of Support | <!-- TBD --> | End of Life as of DataMiner 10.6.x (Q4 2025) |
...
| Resource links | End of Support | <!-- TBD --> | End of Life as of DataMiner version 10.7.x (Q4 2026). |
| [SLScripting as a service](xref:Configuration_of_DataMiner_processes#to-register-slscripting-as-a-service) | End of Support | <!-- TBD --> | End of Life as of DataMiner version 10.7.x (Q4 2026). |
| SRM Service Info | End of Support | <!-- TBD --> | End of Life as of DataMiner version 10.7.x (Q4 2026). |
...
| Virtual platform | End of Support | <!-- TBD --> | End of Life as of DataMiner version 10.7.x (Q4 2026). |
...
| Two-site redundant indexing clusters | End of Support | For optimal redundancy, we recommend switching to [Storage as a Service](xref:STaaS). | End of Life as of DataMiner version 10.7.x (Q4 2026).|
