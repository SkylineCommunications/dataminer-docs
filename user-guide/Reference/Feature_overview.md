...
| Automation: [ExtendedErrorInfo] property | DataMiner 10.2.7/10.3.0 <!-- [ID 33306] -->|
...
| Security: [External user authentication via SAML](xref:Configuring_external_authentication_via_an_identity_provider_using_SAML) | DataMiner 10.2.6/10.3.0 <!-- [ID 32714] -->|
...
|Feature | Minimum DataMiner version |
|---|---|---|---|
