...
|Feature | Minimum DataMiner version | Minimum soft-launch version | Notes |
|---|---|---|---|
| Cassandra cluster | 10.1.0/10.1.2 |   |   |
| Cassandra TLS | 10.3.7/10.3.0 [CU4] |   |   |
| Configurable data offload rate | 9.6.1 |   |   |
...
| [Migrating SRM profiles to the indexing database](xref:Profile_migration_to_elastic) | 10.1.0/10.0.8 |   |   |
...
| Displaying DOM data in dashboards and low-code apps | 10.1.7 |   |   |
