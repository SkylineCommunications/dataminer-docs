...
> *The "Services" folder contains the services hosted in the Agent. For services hosted in other DMAs, there is a folder in the "C:\Skyline DataMiner\RemoteServices" directory. In this folder, you'll see subfolders with the DMAid, and this is where they should be synchronized.
