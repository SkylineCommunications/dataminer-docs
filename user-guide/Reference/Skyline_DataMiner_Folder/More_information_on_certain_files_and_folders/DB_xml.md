...
- **type**: Currently only “Elasticsearch” is supported. The same value is used For OpenSearch and Amazon OpenSearch Service databases. 
...
> - From DataMiner 10.3.0/10.3.3, OpenSearch and Amazon OpenSearch Services can be used.
