...
### Finding the logs of the start window

The log files of the start window application can be found in the following location:
`%LocalAppData%\Skyline\DataMiner\DataMinerCube\Logs\logYYYYMMDD.txt`
> [!NOTE]
