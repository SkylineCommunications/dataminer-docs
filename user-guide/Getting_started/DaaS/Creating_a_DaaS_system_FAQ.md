...
Your DaaS system along with all its associated resources and data will be decomissioned. The DataMiner System will still be recoverable for a further 7 days after the expiration or manually triggering a delete upon request by contacting [daas@dataminer.services](mailto:daas@dataminer.services). The cloud identity and shares will be lost and it will receive a new cloud identity within your organization upon recovery.
