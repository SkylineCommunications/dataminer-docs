...
> [!NOTE]
> On DataMiner Agents running Windows 2008 Server, Windows Vista or a more recent Windows Server operating system, the startup type of the DataMiner services is set to "Automatic (Delayed Start)" by default. This means that DataMiner waits until all Windows services are up and running before launching its own services.
