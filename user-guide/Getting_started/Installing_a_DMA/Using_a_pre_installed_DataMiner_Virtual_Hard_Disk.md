...
1. Fill in the required details to connect your DataMiner Agent to dataminer.services and click *Next*:
   ...
   - *Admin Email*: This email is associated with the dataminer.services account that is part of the organization of which the key is used and will become owner of the DMS on dataminer.services.
