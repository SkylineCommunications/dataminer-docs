...
1. Click *Create*.
   ...
   ![DataMiner System deployment configuration](~/user-guide/images/daas_create_003.png)

1. Wait until your DataMiner System has been deployed.

   The following message will be displayed:

   ![DataMiner System deployment confirmation](~/user-guide/images/daas_create_005.png)
