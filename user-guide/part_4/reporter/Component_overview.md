...
| distriType      | The type of graph. Default: *DISTRIBUTION_DAY*<br> -  If distriType is set to *DISTRIBUTION_GIVEN_WEEKDAY*, *distriTypeParam* can hold a number from 1 to 7 (1 equals Sunday).<br> -  If distriType is set to *DISTRIBUTION_GIVEN_MONTHDAY*, *distriTypeParam* has to be set to the day number. The current date decreased with one month will be taken as day number 1. As a result, this is limited to 31 days.<br> See also: [Alarm distribution graph types](Constants.md#alarm-distribution-graph-types) |
| avgType         | The average type.<br> See also: [Time period](Constants.md#time-period)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| width     | The width of the graph (optional, default: 300 px).                                     |
| height    | The height of the graph (optional, default: 220 px).                                    |
| state     | The alarm state filter.<br> See also: [Alarm severities](Constants.md#alarm-severities) |
| view      | The name of view by which to filter the data.                                           |
...
| trendType  | The type of trend graph. Default: TREND_HOUR<br> See also: [Trend graph types](Constants.md#trend-graph-types)                                                                                                                                                  |
| width      | The width of the graph (optional, default: 300 px).                                                                                                                                                                                                             |
| height     | The height of the graph (optional, default: 220 px).                                                                                                                                                                                                            |
