...
- To run DataMiner Cube in Microsoft Edge, configure Edge to open the URL of the DMA in Internet Explorer compatibility mode. For more information, see *<https://community.dataminer.services/documentation/internet-explorer-support/>*.
