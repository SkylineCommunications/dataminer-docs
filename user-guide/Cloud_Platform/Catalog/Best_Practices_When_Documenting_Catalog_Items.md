...
**Format:** Typically the package solves specific problems for the user. Explain this clearly with accompanying visuals. Optionally provide a link to a [use case on DataMiner Dojo](https://community.dataminer.services/use-cases/).
