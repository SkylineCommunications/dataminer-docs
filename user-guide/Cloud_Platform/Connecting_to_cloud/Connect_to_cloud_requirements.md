...
- Each DMA that will be connected to dataminer.services can reach the following endpoints:
  ...
  > [!TIP]
  > Using SAML? See also: [Additional configuration for systems connected to dataminerservices](#xref:Configuring_external_authentication_via_an_identity_provider_using_SAML#additional-configuration-for-systems-connected-to-dataminerservices)
