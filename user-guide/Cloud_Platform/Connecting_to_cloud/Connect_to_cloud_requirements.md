...
- Each DMA that will be connected to dataminer.services can reach the following endpoints:
  ...
  > [!TIP]
  > Using SAML? See also: [Additional configuration for systems connected to dataminerservices](#additional-configuration-for-systems-connected-to-dataminerservices)
