...
<!-- To use this prompt, you will first have to make sure you are connected to the Collaboration MCP Server. To do so, in VS Code, press Ctrl + Shift + P and select "MCP: List Servers". If the server is not listed yet, select "+ Add Server", then select HTTP, and then enter the URL "https://collaboration-mcp-server.thankfulsea-26bd4902.westeurope.azurecontainerapps.io/mcp", and select "Global" -->
