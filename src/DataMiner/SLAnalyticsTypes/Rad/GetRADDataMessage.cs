...
namespace Skyline.DataMiner.Analytics.Rad
{
    ...
    public class GetRADDataMessage : GetSessionedAnalyticsMessage
    {
        ...
        /// <summary>
        /// Gets or sets the name of the subgroup for which anomaly scores should be retrieved in case of a RAD shared model group.
        ...
        /// </summary>
         ...
         /// <summary>
         /// Gets or sets the unique identifier of the subgroup for which anomaly scores should be retrieved in case of a RAD shared model group.
         /// This field does not need to be specified when the group is not a shared model group (i.e. there is only one subgroup of parameter instances).
        ...
        /// </summary>
        /// <param name="groupName">Name of the RAD parameter group</param>
        /// <param name="subgroupName">Name of the subgroup for which anomaly scores should be retrieved.</param>
        /// <param name="startTime">Start time of the historical time range over which anomaly scores should be retrieved</param>
        /// <param name="endTime">End time of the historical time range over which anomaly scores should be retrieved</param>
