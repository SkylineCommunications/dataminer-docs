...
namespace Skyline.DataMiner.Automation
{
	...
	public interface IEngine
	{
		...
		/// <para>The WebUIVersion is set to 'Default' by default. At present, this means that the new UI (V2) is used. You can instead set this to 'V1' to revert to the old UI or to 'V2' to make sure the new UI will continue to be used even if the default behavior changes. However, if the 'useNewIASInputComponents' URL parameter is used, this will override this configuration in the script (see <see href="xref:Configuring_app_actions_and_behavior_via_URL">Configuring app actions and behavior via the URL</see>).</para>
		/// </remarks>
		/// <example>
		/// <code>
