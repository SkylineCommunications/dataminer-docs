...
namespace Skyline.DataMiner.Automation
{
	...
	public class UIBlockDefinition
	{
		...
		/// <remarks>
		/// <para>Applicable only applicable in web apps in case <see cref="Type"/> is set to Calendar, CheckBox, CheckBoxList, DropDown, Numeric, PasswordBox, RadioButtonList, TextBox, Time.</para>
