...
namespace Skyline.DataMiner.Scripting
{
	...
	public interface SLProtocol
	{
		...
		///			</item>
		///			<item>
		///				<para>In case of a 2x10 matrix, for example, the coordinates of the upper-left crosspoint are iX=1/iY=1, and the coordinates of the bottom-right crosspoint are iX = 2 / iY = 10.</para>
		///			</item>
		///		</list>
		///	</remarks>
