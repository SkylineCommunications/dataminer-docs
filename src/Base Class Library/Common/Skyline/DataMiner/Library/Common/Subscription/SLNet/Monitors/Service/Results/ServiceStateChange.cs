namespace Skyline.DataMiner.Library.Common.Subscription.Monitors
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="ServiceStateChange"/> class.
		/// </summary>
		...
		public ServiceStateChange(Service dataSource, string sourceId, IDms dms, IServiceState state)
		{
		...
		{
			var change = obj as ServiceStateChange;
