...
The tokens to authenticate towards dataminer.services no longer rely on NATS to refresh. This means the tokens will continue to refresh even when NATS is unavailable.

#### 4 April 2025 - Fix - CloudGteway 2.17.4 TCP port leak [ID 42458]
