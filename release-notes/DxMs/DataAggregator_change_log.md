...
Improvements have been made to the [migrator tool](xref:Data_Aggregator_Migrators) to better allow converting GQI queries from the [previous syntax to the new one](xref:Data_Aggregator_settings#gqi-queries).
