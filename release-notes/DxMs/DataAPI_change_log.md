...
When a user tries to push data to the Data API, and there are stopped elements with the specified identifier, the Data API will now update all active elements with that identifier.
