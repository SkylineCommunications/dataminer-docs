...
#### 30 May 2024 - Fix - CoreGateway 2.14.7 - Missing System.Net.Http.dll after upgrading to CoreGateway 2.13.0 - 2.14.6 [ID_39777]

An issue has been resolved where a required `System.Net.Http.dll` went missing after upgrading to a CoreGateway from the version range 2.13.0 - 2.14.6. This did not happen with a clean installation of CoreGateway 2.13.0 - 2.14.6.
