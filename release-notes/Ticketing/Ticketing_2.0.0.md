...
# Ticketing 2.0.0 - Preview

## Prerequisites

Make sure the following mandatory prerequisites are met:
...
In addition, for specific functionality in the Ticketing app, the following optional prerequisites are needed:
...
The Ticketing app has been integrated with the MediaOps.Plan People & Organizations module, enabling the following new features:

- Ability to assign tickets to contacts defined in the People & Organizations module.

- Additional predefined view, *My Tickets*, to only view tickets assigned to the current user.

#### InfraOps Asset Manager integration [ID 44978]

The Ticketing app has been integrated with the InfraOps Asset Manager module, enabling the following new features:
