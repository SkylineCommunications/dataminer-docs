...
#### Dashboards app & Low-Code Apps - Table component: Selecting whether to export raw values or display values to CSV [ID 36467]
...
#### Monitoring app: Parameter values that are URLs will now be rendered as clickable hyperlinks [ID 36423]
...
#### GQI: Enhanced behavior of aggregations applied on empty Elasticsearch tables [ID 36490]
...
#### Dashboards app & Low-Code Apps - Clock components: Custom time zone [ID 36534]
...
#### DataMiner Comparison tool: Enhancements [ID 36570]
...
#### Monitoring app: A new type of datetime boxes will now be used on parameter pages [ID 36606]
...
#### Dashboards app - GQI: Change detection in 'Start from' queries [ID 36690]
...
#### Dashboards app & Low-Code Apps: Only one of the tables sharing an empty query would show a visual replacement [ID 36233]
...
#### Low-Code Apps: Not possible to save empty DOM fields [ID 36276]
...
#### Low-Code Apps: A blank screen would appear when users without permission to access a low-code app tried to log on [ID 36422]
...
#### Dashboards app & Low-Code Apps: Bar and pie chart components would display incorrect data [ID 36601]
...
#### Authentication app: Problem with 'Keep me logged in' option [ID 36647]
...
#### Monitoring app: Problem when receiving parameter table updates via polling [ID 36660]
...
#### Dashboards app & Low-Code Apps - Table component: Problem when trying to display null values returned by the query [ID 36669]
...
#### Dashboards app: An empty menu would open when users with only 'View dashboards' permission clicked the '...' button [ID 36671]
...
#### Dashboards app: Problem when making changes to a dashboard when having that same dashboard open in two separate windows [ID 36718]
