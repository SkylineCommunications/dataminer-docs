...
#### DataMiner Cube will now always connect to a DataMiner Agent via .NET Remoting \[ID 27354\] \[ID 27904\]
...
When running a browser version of DataMiner Cube in Microsoft Internet Explorer, in some cases, a memory leak could occur when using the Chromium browser engine to, for example, visualize webpages in Visual Overview.
