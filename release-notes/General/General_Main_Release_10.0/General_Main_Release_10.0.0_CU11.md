...
# General Main Release 10.0.0 CU11 [ARCHIVED]
...
#### DataMiner Cube: Problem when opening the Protocols & Templates app \[ID 28551\]
...
#### DataMiner Cube: Heatlines displayed in the Alarm Console or in Reports pages of cards would incorrectly be gray \[ID 28579\]
...
#### DataMiner Cube: Problem when logging in due to invalid user image data received from the domain controller \[ID 28749\]
...
#### DataMiner Cube: Properties window would resize when switching to a tab that contained a custom property with a long name \[ID 28873\]
