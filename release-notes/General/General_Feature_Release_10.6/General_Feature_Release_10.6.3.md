...
For a detailed description of the security flow, see below.

1. The user sends a read or count request.

1. The filter is evaluated to find whether it will search the DOM definitions or the DOM instances.

1. If the filter will search the DOM definitions:
