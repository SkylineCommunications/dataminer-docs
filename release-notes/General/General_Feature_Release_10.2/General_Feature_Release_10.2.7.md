...
# General Feature Release 10.2.7 [ARCHIVED]
...
#### System Center - Failover Config: Miscellaneous UI enhancements \[ID 33245\]
...
#### DataMiner Cube - System Center: Additional log files \[ID 33355\]
...
#### Dashboards app: New sidebar icons to list private and shared dashboards \[ID 32854\]
...
#### Security enhancements \[ID 33242\] \[ID 33365\] \[ID 33373\] \[ID 33479\]
...
#### DataMiner Cube - Alarm Console: Pencil icon now identical to that used in Data Display tables \[ID 33442\]
...
#### Web apps: Enhancements with regard to the rendering of GQI tables \[ID 33463\]

A number of enhancements have been made with regard to the rendering of GQI tables.

#### SLDataGateway: Enhanced performance \[ID 33464\]
...
#### Failover: Problem when updating agent states in the Failover subtag of DMS.xml \[ID 33160\]
...
#### DataMiner Cube - Alarm Console: Incorrect values shown in summary alarms \[ID 33238\]
...
#### DataMiner Cube - Alarm Console: Problem when playing a spectrum recording \[ID 33335\]
...
#### DataMiner upgrades: Problems related to upgrade prerequisites \[ID 33353\]
...
#### Dashboards app - GQI: Values of profile parameters without decimals defined would incorrectly be replaced by the maximum integer value \[ID 33418\]
...
#### Ticketing app: Problem when trying to add a value to the State field of a ticket domain \[ID 33537\]
...
#### DataMiner Cube - Resources app: prevent updating new unsaved resource with updated existing resource \[ID 33543\]
...
#### DataMiner Cube desktop app: Problem when installed by means of an MSI package \[ID 33590\]
