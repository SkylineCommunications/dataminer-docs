...
# General Main Release 10.2.0 CU6 [ARCHIVED]
...
#### DataMiner Cube: Spectrum recording icon not shown while recording [ID 34097]
...
#### Dashboards app - GQI: Query columns would incorrectly not get highlighted when clicking the filter icon [ID 34127]
