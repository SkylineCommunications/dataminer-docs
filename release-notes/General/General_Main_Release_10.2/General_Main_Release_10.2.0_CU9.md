...
# General Main Release 10.2.0 CU9 [ARCHIVED]
...
#### Security enhancements [ID 33520]
...
#### Enhanced performance of the DataMiner startup routine [ID 34545]
...
#### Cassandra: Enhanced querying of trend data [ID 34659]
...
#### Ticketing app: Problem with ticket domains incorrectly marked as masked [ID 33449]
...
#### Web apps: List box items not displayed correctly in embedded visual overviews [ID 34474]

<!-- MR 10.2.0 [CU9] - FR 10.2.11 -->

In an embedded visual overview, in some cases, list box items would not be displayed correctly.

#### DataMiner Cube - Trending: Y axis of trend graph would incorrectly show duplicate values [ID 34492]
...
#### Trending: Problem when duplicating table parameters with different values [ID 34591]
...
#### Trending: Table would be cleared of all data after refreshing [ID 34592]
...
#### DataMiner Cube - Trending: Double-clicking a suggestion or alarm event created by SLAnalytics would open a trend graph showing "no data" [ID 34751]
