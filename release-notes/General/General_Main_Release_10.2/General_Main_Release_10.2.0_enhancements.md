...
#### DataMiner Cube start window: Animation enhancements \[ID 28190\]
...
#### Notice when error occurs after disabling and enabling the data offload configuration \[ID 28220\]
...
#### Service & Resource Management: Enhanced loading of Resource Manager module \[ID 29144\]
...
#### Improved SLNet startup performance due to DNS lookup enhancements \[ID 29522\]
...
#### Communication between SLNet and SLHelper will now use NATS \[ID 30845\]
...
#### Dashboards: Improved GQI performance with alarms data source \[ID 31708\]
...
#### Visual Overview: Variables not cleared when booking is no longer selected \[ID 31772\]
