...
# General Main Release 10.2.0 CU15 [ARCHIVED]
...
#### DataMiner Cube - System Center: Enhancements made to Database > Offload section [ID 36037]
...
#### DataMiner Cube - EPM: KPI histogram would incorrectly not be shown [ID 36004]
...
#### DataMiner Cube - Visual Overview: Problem when using placeholders in shape data fields of type 'ChildrenFilter' [ID 36227]
