...
#### Security enhancements [ID 35434] [ID 35667]
...
#### SLAnalytics - Automatic incident tracking: Enhanced performance when fetching relation information [ID 35508]
...
#### SLAnalytics will now send regular notifications instead of client notifications [ID 35591]
...
#### SLAnalytics - Behavioral anomaly detection: Suggestion events or alarm events for change points of type 'flatline' would not get cleared [ID 35645]
...
#### SLAnalytics - Behavioral anomaly detection: An upward level shift directly followed by a downward level shift would incorrectly get categorized as an "unlabeled" change event [ID 35646]
...
#### Behavioral anomaly detection: Suggestion alarms would incorrectly be re-evaluated as normal alarms after a DataMiner restart [ID 35744]
