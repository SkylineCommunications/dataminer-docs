...
A new DataMiner Cloud Pack 2.9.0 has been released which enables [Remote Log Collection](xref:RemoteLogCollection#RemoteLogCollection). The DataMiner Cloud Pack can be found on [DataMiner Dojo](https://community.dataminer.services/downloads/).
