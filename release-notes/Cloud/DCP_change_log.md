...
#### 26 June 2023 - New feature - SupportAssistant 1.4.0 - Offloading of reports and notifications [ID_36726]

Changes have been implemented in DataMiner SupportAssistant to take care of offloading reports and notifications generated by SLWatchDog to dataminer.services to improve the maintenance and support experience. Note that the previous versions since DataMiner SupportAssistant 1.3.1, who also started offloading files, became obsolete for this specific feature and it is advised to update to this new version.
