...
- For release notes related specifically to the **DataMiner web applications** (e.g., Dashboards app, the Monitoring app, etc.), from DataMiner 10.3.3 onwards, see [DataMiner web apps release notes](xref:DataMiner_Web_apps_RNs_index).
