...
The Firefox browser removed quotation marks from links generated by Microsoft Visio, causing display issues within the Citrix environment used by Telenor System. This affected the viewing of dashboards in Cube. To resolve this issue, enhancements have been made to ensure proper dashboard viewing when loading Cube within the Citrix application in the Telenor System.

#### CCAP platforms: Visio lacked 'Entity Import' section [ID_38740]

The CCAP platform connectors have been adjusted so that an *Entity Import* section is now available for Visio, which allows you to set the correct path for importing EP files.
