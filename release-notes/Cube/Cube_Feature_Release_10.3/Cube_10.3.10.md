...
- [Alarm Console: Light bulb [ID 36777] [ID 36871] [ID 36918] [ID 37057] [ID 37136] [ID 37145] [ID 37167] [ID 37184]](#alarm-console-light-bulb-id-36777-id-36871-id-36918-id-37057-id-37136-id-37145-id-37167-id-37184)

- [Protocols & Templates app: Editing, deleting and duplicating elements [ID 36971]](#protocols--templates-app-editing-deleting-and-duplicating-elements-id-36971)

## New features

#### Alarm Console: Light bulb [ID 36777] [ID 36871] [ID 36918] [ID 37057] [ID 37136] [ID 37145] [ID 37167] [ID 37184]
...
#### Trending - Pattern matching: Pattern highlighted when mouse pointer hovers over label [ID 36863]
...
#### Protocols & Templates app: Editing, deleting and duplicating elements [ID 36971]
...
#### Alarm Console: No 'Include masked alarms' option anymore when creating a history tab [ID 37020]
...
#### Trending - Pattern matching: Pattern occurrences will now be added to a trend graph in real time [ID 37153]
...
#### Trending - Pattern matching: Loading indication around light bulb icon while loading time-scoped related parameters [ID 36831]
...
#### Tooltip added for 'Edit Visio drawing' user permission [ID 37095]
...
#### Alarm templates: Style of toggle buttons has been made consistent with the styles used in the Cube themes [ID 37158]
...
#### Trending - Pattern matching: Problem when loading multivariate pattern [ID 36863]
...
#### Trending - Pattern matching: Problem when adding and highlighting curves [ID 37174]
...
#### DataMiner Cube v10.3.9 would receive incorrect EPM data when connected to a DataMiner Agent v10.3.8 or older [ID 37391]
