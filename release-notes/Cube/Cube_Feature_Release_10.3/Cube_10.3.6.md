...
> [!TIP]
>
> - For release notes related to the general DataMiner release, see [General Feature Release 10.3.6](xref:General_Feature_Release_10.3.6).
...
#### Trending: Managing trend patterns in the 'Pattern Overview' window [ID 35694] [ID 36114]
...
#### DataMiner Cube desktop app: Unused Cube versions will now automatically be removed [ID 35795]
...
#### Visual Overview: Browser shapes will no longer be reloaded when their URL only had a fragment change [ID 36044] [ID 36104]
...
#### System Center - Database: Warning when a DataMiner Agent in the cluster is offline [ID 36184]
...
#### Trending - Parameter relationships: Light bulb icon would not appear if ModelHost DxM stopped working [ID 35868]
