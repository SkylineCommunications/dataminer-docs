...
#### Trending - Pattern matching: Colors will now be used to differentiate how matches were detected [ID 34898] [ID 34947]
...
#### Visual Overview - ListView: Highlighting rows based on booking color [ID 35157]
...
#### Visual Overview: Visualizing EPM object statistics in a shape [ID 35222]
...
#### Trending - pattern matching: Enhanced feedback when creating a trend pattern tag failed [ID 34963]
...
#### Profiles app: A profile instance would incorrectly list parameters that had been removed from the profile definition [ID 34679] [ID 34771]
...
#### Trending: Light bulb icon would incorrectly not re-appear after removing a suggested parameter of type string from a graph [ID 35133]

<!-- MR 10.3.0 - FR 10.3.2 -->
<!-- Not added to 10.3.0 -->

When you removed a suggested parameter of type string from a trend graph, the light bulb icon would incorrectly not re-appear in the upper-right corner of the graph.
...
#### Surveyor: Problem when upgrading a view of which the name contains invalid characters [ID 35208]
...
#### Visual Overview: Problem with conditional shape manipulation actions [ID 35211]
...
#### Element Connections app: Problems when creating or updating connections [ID 35228]
...
#### Trending: 'Trending is currently not available ...' error would incorrectly be displayed while viewing the trend graph of an EPM object [ID 35234]
...
#### Visual Overview: Dynamically positioned shapes could no longer be re-arranged using drag-and-drop [ID 35241]
